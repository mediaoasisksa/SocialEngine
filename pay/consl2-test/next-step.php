...
function request() {
    ...
    $data = $_POST;
    $data['entityid'] = "8ac7a4ca87ba6ed60187bc9d8a41023c";
    if($data['card'] == "mada") {
        $data['entityid'] = "8ac7a4ca87ba6ed60187bc9e08290240";
    }
...
<form action="https://consl2.com/se6401/bookings/transaction/finish/state/complete/card/mada/order_id/<?php echo $_POST['id'];?>" class="paymentWidgets" data-brands="MADA"></form>
<?php else:?>
<form action="https://consl2.com/se6401/bookings/transaction/finish/state/complete/card/card/order_id/<?php echo $_POST['id'];?>" class="paymentWidgets" data-brands="VISA MASTER"></form>
<?php endif;?>
