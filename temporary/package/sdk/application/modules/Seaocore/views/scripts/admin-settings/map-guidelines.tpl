          ...
          <div class="steps">
            ...
            <div id="step-1" style='display: none;'>
              <p>
						   ...
						   <?php echo $this->translate("A) Go to this URL for steps to configure Google Places API key for your SocialEngine website:");?> <a href="https://www.youtube.com/watch?v=uaw_6BxZPu0&feature=youtu.be" target="_blank" style="color:#5BA1CD;">https://www.youtube.com/watch?v=uaw_6BxZPu0&feature=youtu.be</a><br /><br /> 
