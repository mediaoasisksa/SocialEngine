...
echo '<div class="siteevent_grid_footer seaocore_button"><a href="javascript:void(0);"  class="siteevent_share_links_toggle"><span class="seao_icon_share"></span><span>' . $this->translate('Share') .'</span></a>'
