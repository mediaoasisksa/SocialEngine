 ...
 * @version    $Id: _shareReviewButtons.tpl 6590 2014-01-02 00:00:00Z SocialEngineAddOns $
...
echo '<div class="sitereview_grid_footer"><div><a href="javascript:void(0);"  class="sitereview_share_links_toggle"><span class="seao_icon_share"></span>' . $this->translate('Share') . '</a>'
. '<div class="sitereview_share_links" style="display:none;"><ul class="dropdown-menu social-share tall-review-box-menu">'
