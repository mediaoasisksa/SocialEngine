...
<div class="info_tip_wrapper" style="top:40%; left:40%;">
 ...
 ?>
                ...
                <?php if($this->result->getPhotoUrl('thumb.profile')):?>
                  <a href="<?php echo $this->result->getHref();?>"><i style="background-image:url('<?php echo $this->result->getPhotoUrl('thumb.profile');?>');"></i></a>
                  <?php else:?>
                  <a href="<?php echo Engine_Api::_()->seaocore()->getUserPhotoHref($this->result);?>"><i style="background-image:url('application/modules/User/externals/images/nophoto_user_thumb_profile.png')"></i></a>
            ...
            $this->resource_type == 'poll' || $this->resource_type == 'feedback' || $this->resource_type == 'sitefaq_faq' || $this->resource_type == 'sitereview_wishlist' || $this->resource_type == 'sitestore_wishlist'  || $this->resource_type == 'sitereview_review' || $this->resource_type == 'sitestoreproduct_review' || $this->resource_type == 'sitestoreproduct_wishlist'  || $this->resource_type == 'sitereview_topic' || $this->resource_type == 'sitemember_review'):   ?>
						<?php //echo $this->htmlLink($this->result->getHref(), $this->itemPhoto($this->result->getOwner(), 'thumb.profile')); ?>
                                                <a href="<?php echo $this->result->getHref();?>"><i style="background-image:url('<?php echo $this->result->getOwner()->getPhotoUrl('thumb.profile');?>');"></i></a>
					<?php elseif($this->resource_type == 'document' || $this->resource_type == 'groupdocument_document' || $this->resource_type == 'eventdocument_document' || $this->resource_type == 'sitepagedocument_document' || $this->resource_type == 'sitebusinessdocument_document'): ?>
						<?php if(!empty($this->result->photo_id)): ?>
							<?php //echo $this->htmlLink($this->result->getHref(), $this->itemPhoto($this->result, 'thumb.icon'), array()) ?>
                                                <a href="<?php echo $this->result->getHref();?>"><i style="background-image:url('<?php echo $this->result->getPhotoUrl('thumb.icon');?>');"></i></a>
						<?php elseif ($this->resource_type == 'document'): ?>
							<?php //echo $this->htmlLink($this->result->getHref(), '<img src="'. $this->result->thumbnail .'" class="thumb_icon" />', array() ) ?>
                                                <a href="<?php echo $this->result->getHref();?>"><i class="thumb_icon" style="background-image:url('<?php echo $this->result->thumbnail;?>');"></i></a>
					...
					<?php elseif(empty($this->result->photo_id) &&  ($this->resource_type == 'music_playlist')):?>
						<?php //echo $this->htmlLink($this->result->getHref(), $this->itemPhoto($this->result->getOwner(), 'thumb.profile')); ?>
                                                <a href="<?php echo $this->result->getHref();?>"><i class="thumb_icon" style="background-image:url('<?php echo $this->result->getOwner()->getPhotoUrl('thumb.profile');?>');"></i></a>
					<?php else: ?>
						<?php //echo $this->htmlLink($this->result->getHref(), $this->itemPhoto($this->result, 'thumb.normal')); ?>
                                                <a href="<?php echo $this->result->getHref();?>"><i class="thumb_icon" style="background-image:url('<?php echo $this->result->getPhotoUrl('thumb.normal');?>');"></i></a>
					<?php endif; ?>
...
(!empty($this->viewer_id)) ): ?>
        ...
        <?php //FOR SHARE LINK.
         if ( !empty ($this->viewer_id) && ($this->resource_type != 'user') && ($this->resource_type != 'siteevent_event') && ($this->resource_type != 'forum_post') && ($this->resource_type != 'forum_topic') && ($this->resource_type != 'album') && !empty($info_values) && in_array("share", $info_values) ): ?>
					<?php if (!$flag) : ?>
						<div class="info_tip_content_bottom">
					<?php $flag = true; endif; ?>
