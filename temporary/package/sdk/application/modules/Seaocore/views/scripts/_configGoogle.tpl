				...
				<div class="steps">
					...
					<div id="googlestep-1" style='display: none;'>
						...
						<?php echo $this->translate("1) To start using Google APIs console go here :");?> <a href="https://code.google.com/apis/console" target="_blank" style="color:#5BA1CD;">https://code.google.com/apis/console</a><br />
						 ...
						 <?php echo $this->translate("2) Go to this URL for steps to configure Google Integration on your SocialEngine website : ");?><a href="https://youtu.be/XCd1tlIsCxY
" target="_blank" style="color:#5BA1CD;">https://youtu.be/XCd1tlIsCxY</a><br/>					
						</p>					
					</div>
				</div>
			</li>
