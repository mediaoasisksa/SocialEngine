...
class Sitecourse_Widget_NewestCoursesController extends Seaocore_Content_Widget_Abstract {
	...
	public function indexAction(){
		...
		$courses = Engine_Api::_()->getDbtable('courses','sitecourse')->getNewestCourses($itemCount,$sortingCriteria,$newestThreshold);
		if(empty($courses)) {
