...
class Zend_Controller_Request_Http extends Zend_Controller_Request_Abstract
{
    ...
    public function setBaseUrl($baseUrl = null)
    {
        ...
        if ($baseUrl === null) {
            ...
            if ($requestUri && 0 === strpos($requestUri, $baseUrl)) {
                // full $baseUrl matches
                $this->_baseUrl = $baseUrl;
                return $this;
            }

            if ($requestUri && 0 === strpos($requestUri, dirname($baseUrl))) {
            ...
            if ($truncatedRequestUri && (empty($basename) || !strpos($truncatedRequestUri, $basename))) {
