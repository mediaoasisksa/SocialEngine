 ...
 * @license    http://www.socialengine.com/license/
 */
class Album_Form_Admin_Category extends Engine_Form
{
  protected $_field;
  ...
  public function init()
  {
    ...
    */
    ...
    $categoryAlbum = $albumTable->isAlbumExists($category_id, 'category_id');
    $subcatAlbum = $albumTable->isAlbumExists($category_id, 'subcat_id');
    $subsubcatAlbum = $albumTable->isAlbumExists($category_id, 'subsubcat_id');
    
    if(engine_count($subcategory) == 0 && engine_count($subsubcategory) == 0 && empty($category->subsubcat_id) && empty($categoryAlbum) && empty($subcatAlbum) && empty($subsubcatAlbum)) {
