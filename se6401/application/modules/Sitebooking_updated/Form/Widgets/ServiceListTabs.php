...
class Sitebooking_Form_Widgets_ServiceListTabs extends Engine_Form
{
  ...
  {   
    ...
    $this->addElement('MultiCheckbox', 'list_id', array(
      ...
      // 'value' => array('featured','sponsored','hot','newlabel','approved','likeCount','commentCount','reviewCount','rating','creationDate'),
      // 'required' => true,
    ));
    ...
    $this->addElement('MultiCheckbox', 'view_id', array(
      'label' => 'View',
      'description' => "Note: If both the view or only grid view is selected then it will show filtered services in grid view first. Please note when no 'List' is selected then the view buttons (list or grid view) will not appear on user side.",
      'multiOptions' => $view,
