  ...
  <?php foreach( $this->paginator as $item ): ?>
    ...
    <div class='item category'>
      ...
      <?php if($this->compare == "serviceHome"): ?>
        <div class="_info">
            <h3 class="_title"><?php echo $this->htmlLink(array('action' => 'index','route' => 'sitebooking_service_browse','category' => $item->category_id,'reset' => true),  $item->category_name) ?>
            </h3>
        </div>
      <?php endif;?>
      ...
      <?php if($this->compare == "providerHome"): ?>
        <div class="_info">
            <h3 class="_title"><?php echo $this->htmlLink(array('action' => 'index','route' => 'sitebooking_provider_general','category' => $item->category_id,'reset' => true),  $item->category_name) ?>
            </h3>
        </div>
      <?php endif;?>
