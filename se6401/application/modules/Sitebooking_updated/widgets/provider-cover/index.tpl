	...
	<div class="_bottom">
		<div class="_info">
          ...
          <?php endforeach; ?>
				...
				<div class="_stats">
					<span class="_like"><i class="fa fa-thumbs-up"></i><?php echo $this->item->like_count;?></span>
					<span class="_comment"><i class="fa fa-comment"></i></i><?php echo $this->item->comment_count;?></span>
				</div>
			</div>
		</div>
	</div>
