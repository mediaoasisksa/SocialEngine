    ...
    <form method="post" class="global_form_box" action="" width="100%">
      ...
      <div class="sb_admin_calendar">
        <?php 
          ...
          $form = new Seaocore_Form_Element_DatepickerCalendarDateTime('bookingdate');
      ...
      <div class="sb_admin_calendar">
        <?php 
          ...
          $form = new Seaocore_Form_Element_DatepickerCalendarDateTime('servicingdate');
          $attributes['options'] = $form->getMultiOptions();
  ...
  <script type="text/javascript">
    ...
    en4.core.runonce.add(function() {
        scriptJquery(document).ready(function () {
          if (scriptJquery('#bookingdate-minute') && scriptJquery('#servicingdate-minute')) {
              scriptJquery('#bookingdate-minute').remove();
              scriptJquery('#servicingdate-minute').remove();
          }
          if (scriptJquery('#bookingdate-ampm') && scriptJquery('#servicingdate-ampm')) {
              scriptJquery('#bookingdate-ampm').remove();
              scriptJquery('#servicingdate-ampm').remove();
          }
          if (scriptJquery('#bookingdate-hour') && scriptJquery('#servicingdate-hour')) {
              scriptJquery('#bookingdate-hour').remove();
              scriptJquery('#servicingdate-hour').remove();
          }

          if (scriptJquery('#calendar_output_span_bookingdate-date')[0]) {
              scriptJquery('#calendar_output_span_bookingdate-date').css('display','none');
          }

          if (scriptJquery('#calendar_output_span_servicingdate-date')[0]) {
              scriptJquery('#calendar_output_span_servicingdate-date').css('display','none');
          }

          if (scriptJquery('#bookingdate-date')) {
              scriptJquery('#bookingdate-date').attr('type', 'text');
          }

          if (scriptJquery('#servicingdate-date')) {
              scriptJquery('#servicingdate-date').attr('type', 'text');
          }
    });
    }); 
