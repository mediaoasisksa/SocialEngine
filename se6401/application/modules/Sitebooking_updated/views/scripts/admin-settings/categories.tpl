...
<script type="text/javascript">
  ...
  {
    new Sortables(scriptJquery(divId), {handle: handleClass, onComplete: function() {
  ...
  {
    scriptJquery('#ajaxframe').src = '<?php echo $this->url(array('module' => 'sitebooking', 'controller' => 'settings', 'action' => 'categories'), 'admin_default', true) ?>?task=changeorder&sitebookingorder=' + sitebookingorder + '&divId=' + divId;
  }
  ...
  function showsubcate(option, cate_id, level) {
    ...
    if (level == 1) {
      if (option == 1) {
        scriptJquery('#subcate_admin_new_' + cate_id).css('display','none');
        scriptJquery('#subcats_' + cate_id).css('display','none');
        scriptJquery('#hide_cate_' + cate_id).css('display','none');
        scriptJquery('#show_cate_' + cate_id).css('display','block');
      } else if (option == 2) {
        scriptJquery('#subcate_admin_new_' + cate_id).css('display','block');
        scriptJquery('#subcats_' + cate_id).css('display','block');
        scriptJquery('#hide_cate_' + cate_id).css('display','block');
        scriptJquery('#show_cate_' + cate_id).css('display','none');
      }
    } else if (level == 2) {
      if (option == 1) {
        scriptJquery('#treesubcate_admin_new_' + cate_id).css('display','none');
        scriptJquery('#treesubcats_' + cate_id).css('display','none');
        scriptJquery('#treehide_cate_' + cate_id).css('display','none');
        scriptJquery('#treeshow_cate_' + cate_id).css('display','block');
      } else if (option == 2) {
        scriptJquery('#treesubcate_admin_new_' + cate_id).css('display','block');
        scriptJquery('#treesubcats_' + cate_id).css('display','block');
        scriptJquery('#treehide_cate_' + cate_id).css('display','block');
        scriptJquery('#treeshow_cate_' + cate_id).css('display','none');
      }
    }
  }

  if (scriptJquery('#top_content')) {
    <?php
  ...
  if (scriptJquery('#bottom_content')) {
    <?php
