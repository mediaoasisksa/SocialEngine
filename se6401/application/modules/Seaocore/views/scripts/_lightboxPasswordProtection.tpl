...
<form method="post" action="" class="global_form" enctype="application/x-www-form-urlencoded" id="sitealbum_check_password_protection">
    <div>
        <div>
            <h3><?php echo $this->translate("Private Photo Album"); ?></h3>
            <p class="form-description"><?php echo $this->translate("This is password protected Photo Album."); ?></p>
            <div class="form-elements">
                <div class="form-wrapper" id="password-wrapper"><div class="form-label" id="password-label">
                    ...
                    <div class="form-element" id="password-element">
                        ...
                        <p class="description"><?php echo $this->translate("To view this photo album, please provide the correct password."); ?></p>
                    </div>
                </div>
                <div class="form-wrapper" id="submitForm-wrapper"><div class="form-label" id="submitForm-label">&nbsp;</div>
                    <div class="form-element" id="submitForm-element">
                        <button onclick="checkPasswordProtection(scriptJquery('#sitealbum_check_password_protection'));
