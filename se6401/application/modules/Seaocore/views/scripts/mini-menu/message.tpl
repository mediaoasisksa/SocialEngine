...
<script type="text/javascript">
  en4.core.runonce.add(function () {
    SEAOMooVerticalScroll('seaocore_message_main_right_content_area', 'seaocore_message_scroll_main_right_content', {});
    scriptJquery('#seaocore_message_scroll_main_right_content ul>li>div._message_list').on('click',function(event){
      window.location.href = scriptJquery(this).attr('data-href'); 
    });
  });
</script>