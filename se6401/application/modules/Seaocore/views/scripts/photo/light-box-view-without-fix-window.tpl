...
<?php if ($this->canComment): ?>
  ...
  ?>onclick="en4.seaocore.photolightbox.comments.like('<?php echo $this->subject()->getType() ?>', '<?php echo $this->subject()->getIdentity() ?>');" href="javascript:void(0);" class="photo_lightbox_like"
    ...
    <a href="javascript:void(0);" onclick="if (scriptJquery('#comment-form-open-li_<?php echo $this->subject()->getType() ?>_<?php echo $this->subject()->getIdentity() ?>')) {
      ...
      scriptJquery('#comment-form_<?php echo $this->subject()->getType() . "_" . $this->subject()->getIdentity() ?>').find('body').focus();" class="photo_lightbox_comment" title="<?php echo $this->translate('Post
...
<?php if ($this->canEdit): ?>
  <div class="photo_lightbox_user_right_options seaocore_lightbox_user_right_options"
    ...
    <a class="icon_photos_lightbox_rotate_ccw"  onclick="scriptJquery(this).set('class', 'icon_loading');
  ...
  ?>" ></a>
    <a class="icon_photos_lightbox_rotate_cw" onclick="scriptJquery(this).set('class', 'icon_loading');
  ...
  ?>" ></a>
    <a class="icon_photos_lightbox_flip_horizontal" onclick="scriptJquery(this).set('class', 'icon_loading');
  ...
  ?>" ></a>
    <a class="icon_photos_lightbox_flip_vertical"  onclick="scriptJquery(this).set('class', 'icon_loading');
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
    ...
    scriptJquery(taggerInstanceSeaocore).on({
      'onBegin': function() {
...
<script type="text/javascript">
  function featuredPhoto()
  {
    en4.core.request.send(scriptJquery.ajax({
      ...
      success: function(responseHTML) {
        if (scriptJquery('#featured_sitealbum_photo').css('display') == 'none') {
          scriptJquery('#featured_sitealbum_photo').css('display', "");
          scriptJquery('#un_featured_sitealbum_photo').css('display', "none");
        } else {
          scriptJquery('#un_featured_sitealbum_photo').css('display', "");
          scriptJquery('#featured_sitealbum_photo').css('display', "none");
        }
      }
    }), true);
  ...
  function featuredpagealbumPhoto(photo_id)
  {
    en4.core.request.send(scriptJquery.ajax({
      ...
      'data': {
       ...
       success: function(responseHTML) {
        if (scriptJquery('#featured_sitepagealbum_photo').css('display') == 'none') {
          scriptJquery('#featured_sitepagealbum_photo').css('display', "");
          scriptJquery('#un_featured_sitepagealbum_photo').css('display', "none");
        } else {
          scriptJquery('#un_featured_sitepagealbum_photo').css('display', "");
          scriptJquery('#featured_sitepagealbum_photo').css('display', "none");
        }
      }
    }), true);
  ...
  function featuredbusinessalbumPhoto(photo_id)
  {
    en4.core.request.send(scriptJquery.ajax({
      ...
      'data': {
       ...
       success: function(responseHTML) {
        if (scriptJquery('#featured_sitebusinessalbum_photo').css('display') == 'none') {
          scriptJquery('#featured_sitebusinessalbum_photo').css('display', "");
          scriptJquery('#un_featured_sitebusinessalbum_photo').css('display', "none");
        } else {
          scriptJquery('#un_featured_sitebusinessalbum_photo').css('display', "");
          scriptJquery('#featured_sitebusinessalbum_photo').css('display', "none");
        }
      }
    }), true);
  ...
  function featuredgroupalbumPhoto(photo_id)
  {
    en4.core.request.send(scriptJquery.ajax({
     ...
     success: function(responseHTML) {
        if (scriptJquery('#featured_sitegroupalbum_photo').css('display') == 'none') {
          scriptJquery('#featured_sitegroupalbum_photo').css('display', "");
          scriptJquery('#un_featured_sitegroupalbum_photo').css('display', "none");
        } else {
          scriptJquery('#un_featured_sitegroupalbum_photo').css('display', "");
          scriptJquery('#featured_sitegroupalbum_photo').css('display', "none");
        }
      }
    }), true);
      ...
      request = scriptJquery.ajax({
        ...
        success: function(response) {
          ...
          // Ok, let's refresh the page I guess
            scriptJquery('#canReloadSeaocore').val(1);
          scriptJquery('#media_photo').attr('src', response.href);
          scriptJquery('#media_photo').css('marginTop', "0px");
        }
      });
      return request;
    },
      ...
      en4.core.request.send(scriptJquery.ajax({
        ...
        success: function(responseJSON) {
          if ($type(responseJSON) == 'object' && $type(responseJSON.status)) {
            if (scriptJquery('#'+type + 'like_link').length)
              scriptJquery('#'+type + 'like_link').css('display', "none");
            if (scriptJquery('#'+type + 'unlike_link').length)
              scriptJquery('#'+type + 'unlike_link').css('display', "inline-block");
          }
        }
      }), {
    ...
    unlike: function(type, id, comment_id) {
      en4.core.request.send(scriptJquery.ajax({
        ...
        success: function(responseJSON) {
          if ($type(responseJSON) == 'object' && $type(responseJSON.status)) {
            if (scriptJquery('#'+type + 'unlike_link').length)
              scriptJquery('#'+type + 'unlike_link').css('display', "none");
            if (scriptJquery('#'+type + 'like_link').length)
              scriptJquery('#'+type + 'like_link').css('display', "inline-block");
          }
        }
      }), {
        'element': scriptJquery('#comments')
