...
<ul class="sea_val_photos_thumbs">	  
  <?php foreach ($this->paginator as $photo): ?>
  	<li id="lb-all-thumbs-photo-<?php echo $photo->getIdentity() ?>" onclick="onclickPhotoThumb(scriptJquery(this)); photopaginationSocialenginealbum('<?php echo $this->escape($photo->getHref()) ?>','','<?php echo $photo->getPhotoUrl(); ?>');closeAllPhotoContener();" >     
      <a class="thumbs_photo"  onclick="onclickPhotoThumb(scriptJquery(this)); photopaginationSocialenginealbum('<?php echo $this->escape($photo->getHref()) ?>','','<?php echo $photo->getPhotoUrl(); ?>');closeAllPhotoContener();" >
