...
include_once APPLICATION_PATH . '/application/modules/Seaocore/views/scripts/_loginSEAO.tpl'; 
if( !empty($this->seaoDetailsSession) ):
  ...
  elseif($this->selectedMenuType == "disabled")
    echo $this->content()->renderWidget('seaocore.seaocores-upgrade', array('type' => "disabled"));
endif;
?>
