...
ACTION<br />$this->view->editAction = "edit";<br /><br />//GET COMMENT<br />$this->view->canComment = 1;<br />break</b>;');?><br />
        ...
        ?>
        <?php if(empty(Engine_Api::_()->seaocore()->checkVersion($seaocoremoduleversion, '4.2.5p1'))) :?>
					<li>	
						<div class="steps">
	...
	<?php echo $this->translate("b) Go to the line around line number 37 having: <b style='font-weight:bold;'>if(scriptJquery('.feed_attachment_event_photo').length) { </b>.");?><br />
	...
	<?php echo $this->translate("d) Paste this code at around line number 46, i.e., after the line mentioned in the previous point, after modifying the code according to the desired module / plugin. I.e., add the code for the desired module / plugin, similar to the code for Events: <br /><b style='font-weight:bold;'>if(scriptJquery('.feed_attachment_event_photo').length) {<br />//DISPLAY ACTIVITY FEED IMAGES IN THE LIGHTBOX FOR THE EVENT <br />if(scriptJquery('.feed_attachment_event_photo').length) {<br />scriptJquery('.feed_attachment_event_photo').each(function(el){<br />el.getElement('.thumb_normal').off('click').on('click', function(e) {<br />e.stop();<br />href = openLightboxforActivityFeed(el);<br />openSeaocoreLightBox(href);<br />});<br />});<br />}</b>;")?>
	...
	<br />
        ...
        <?php endif;?>
        <?php if(!Engine_Api::_()->seaocore()->checkVersion($seaocoremoduleversion, '4.2.5p1')) :?>
					<li>	
						<div class="steps">
							<a href="javascript:void(0);" onClick="guideline_show('step-6');"><?php echo $this->translate("Step 6") ?></a>              
							<div id="step-6" style='display: none;'>
        ...
        <li>	
          <div class="steps">
            <p>
              ...
              <?php echo '<a href="https://socialengine.atlassian.net/wiki/spaces/SU/pages/5145063/SE+PHP+-+Server+Information" target="_blank"> KB article</a>.'; ?>
            </p>
          </div>
        </li>
      </ul>
