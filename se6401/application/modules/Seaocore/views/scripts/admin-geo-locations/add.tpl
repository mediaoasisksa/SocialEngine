...
<script type="text/javascript">
    ...
    var autocomplete = new google.maps.places.Autocomplete(scriptJquery('#location')[0], options);
    google.maps.event.addListener(autocomplete, 'place_changed', function() {
        ...
        scriptJquery('#zipcode').val(zipcode);       
        scriptJquery('#city').val(city);        
        scriptJquery('#state').val(state);        
        scriptJquery('#country').val(country);        
        scriptJquery('#address').val(address);
        scriptJquery('#formatted_address').val(place.formatted_address);
