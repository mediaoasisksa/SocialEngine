 ...
 */
  ...
  $this->headLink()->appendStylesheet( $this->layout()->staticBaseUrl . 'application/modules/Seaocore/externals/styles/style_login-signup-popup.css' );
?>
<script type="text/javascript">
  var seaocoreSignupLoginPopupContentStorage = '';
</script>
<div id="seaocore_login_signup_popup_widget_parent_div" style="display:none;">
  <div id="seaocore_login_signup_popup" class="seaocore_login_signup_popup_modal" style="display: none;">
    <div class="_headline-poup">
      <?php if( $this->allowClose ): ?>
        <div class="_close_icon" onclick="Smoothbox.close();">
          <i class="fa fa-times" aria-hidden="true" ></i>
        </div>
      <?php endif; ?>
      <div class='seaocore_login_signup_popup_modal_header'>
    ...
    <div class="_form_wapper">
      <?php if( !in_array($this->pageIdentity, array('user-auth-login', 'sitelogin-auth-login')) ) : ?>
        ...
        <div class="seao_user_auth_popup _form_cont">
          ...
          ?>
          <?php if( $this->pageIdentity !== 'user-signup-index' ): ?>
            <ul class="_navigation _footer_bottom">
              <li class="user_signup_form_tab"  data-role="seao_user_signup_popup">
      ...
      <?php if( !in_array($this->pageIdentity, array('user-signup-index', 'sitequicksignup-signup-index')) ) : ?>
        ...
        <div class="seao_user_signup_popup _form_cont">
          <?php echo $this->action( 'index', 'signup', ( ( Engine_Api::_()->hasModuleBootstrap('sitequicksignup') ) ? 'sitequicksignup' : 'user' ), array('disableContent' => true) ); ?>
          <?php if( $this->pageIdentity !== 'user-auth-login' ): ?>
            <ul class="_navigation _footer_bottom">
              <li class="user_login_form_tab" data-role="seao_user_auth_popup">
