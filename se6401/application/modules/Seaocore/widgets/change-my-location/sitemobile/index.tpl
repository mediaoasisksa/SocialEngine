...
<?php if ($this->locationSpecific): ?>
    ...
    <script type="text/javascript">
         scriptJquery('#select[name=location_mobile]').val('<?php echo $this->locationValue ?>');
        function changeSpecificLocation() {
        var specificLocation = scriptJquery('#select[name=location_mobile]').val();
             scriptJquery('#current_url').val('<?php echo $_SERVER['REQUEST_URI']; ?>');
  ...
  echo $this->getMyLocationDetailsCookie['location'];
    ...
    $.ajax({
      ...
      data: {
        ...
        latitude: scriptJquery('#latitude').val(),
        longitude: scriptJquery('#longitude').val(),
      },
