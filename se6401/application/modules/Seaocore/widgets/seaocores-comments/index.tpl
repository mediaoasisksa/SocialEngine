...
"'.$this->subject()->getIdentity().'", "'.($this->page + 1).'","'. $this->show_bottom_post .'")'
      ...
      <li id='comment-form-open-li_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity() ?>' onclick="(this).style.display ='none'; scriptJquery('#comment-form_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity() ?>').css('display','');scriptJquery('#comment-form_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity() ?>').find('body').focus();"> 
        <div/></div>
  ...
  <script type="text/javascript">
    en4.core.runonce.add(function(){
      scriptJquery(scriptJquery('#comment-form_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity()
?>').body).autogrow();
