  ...
  <script type="text/javascript">
    en4.core.runonce.add(function() {
      ...
      var activityViewMore = window.activityViewMore = function(next_id, subject_guid) {
        ...
        scriptJquery('#feed_loading').css('display', '');
          ...
          success : function(responseHTML) {
            Elements.from(responseHTML).appendTo(scriptJquery('#activity-feed'));
...
<?php if( !empty($this->checkUpdate) ): // if this is for the live update
  ...
  echo "<script type='text/javascript'>
        ...
        <div class='tip'>
          <span>
            <a href='javascript:void(0);' onclick='javascript:activityUpdateHandler.getFeedUpdate(".$this->firstid.");scriptJquery(\"#feed-update\").empty();'>
