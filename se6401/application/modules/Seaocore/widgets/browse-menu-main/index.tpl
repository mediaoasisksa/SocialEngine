...
//var myFx = new Fx.Slide('seao_flop_toggle').hide();
   function showSlideIn() {
        if(scriptJquery('#seao_flop_toggle').css('display') == '' || scriptJquery('#seao_flop_toggle').css('display') == 'none') {
            scriptJquery('#seao_flop_toggle').css('display', 'block');
        } else {
            scriptJquery('#seao_flop_toggle').css('display', 'none');
        }
    }
</script>
