...
return array(
    'package' => array(
        ...
        'repository' => 'null',
        'title' => 'SocialApps.tech Basic Plugin',
        'description' => 'SocialApps.tech Basic Plugin',
        ...
        'files' => array(
            ...
            'application/libraries/Scaffold/modules/DomElementsSeao/DomElementsSeao.php',
            'application/libraries/Engine/Form/Element/DropZoneDrogAndDrop.php',
            'application/libraries/Engine/Form/Decorator/FormDropZoneDrogAndDrop.php',
        ),
    ),
    // Items ---------------------------------------------------------------------
    'items' => array(
