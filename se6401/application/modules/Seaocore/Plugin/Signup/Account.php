...
/*
 * Seaocore_Plugin_Signup_UserAccount This is copy the complete code of User_Plugin_Signup_Account
 * from application/modules/User/Plugin/Signup/Account.php, For latest code you can simply copy the code are paste here
 */
class Seaocore_Plugin_Signup_UserAccount extends Core_Plugin_FormSequence_Abstract
{
...
class User_Plugin_Signup_Account extends Seaocore_Plugin_Signup_UserAccount
{
