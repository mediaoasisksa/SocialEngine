 ...
 * @version    $Id: install.php 2010-11-18 9:40:21Z SocialApps.tech $
...
sitebusinesspoll', 'sitebusinessmusic', 'sitebusinessvideo', 'sitebusinessreview', 'sitebusinessmember', 'sitebusinessurl');
    ...
    $db->query("UPDATE `engine4_core_menuitems` SET  `label` =  'SEAO - SocialApps.tech Core' WHERE  `engine4_core_menuitems`.`name` ='core_admin_plugins_Seaocore';");
