...
class Sitecore_Plugin_Core extends Zend_Controller_Plugin_Abstract
{
  ...
  public function onRenderLayoutDefault($event)
  {
    ...
    $view->headLink()->appendStylesheet($view->layout()->staticBaseUrl."externals/selectize/css/normalize.css");
    $headScript = new Zend_View_Helper_HeadScript();
    $headScript->appendFile($view->layout()->staticBaseUrl.'externals/selectize/js/selectize.js');
