 ...
 * @version    $Id: index.tpl 2011-02-16 9:40:21Z SocialApps.tech $
...
<h3>
    <?php echo $this->translate('Latest versions of SocialApps.tech plugins for your site') ?>
</h3>
<p>
    <?php if(empty($this->type)): ?>
        <?php echo $this->translate('Here, you can upgrade the latest version of these plugins by using ‘Upgrade’ button available in front of all the desired plugins that needs to be upgraded.<br />The latest versions of these plugins are also available to you in your SocialApps.tech Client Area. Login into your SocialApps.tech Client Area here: <a href="https://socialapps.tech/user/login" target="_blank">https://socialapps.tech/user/login</a>.'); ?>
    <?php else: ?>
        <?php echo $this->translate('Here, you can upgrade the latest version of the disabled plugins on your website by using ‘Upgrade’ button available in front of all the desired plugins. The latest versions of these plugins are also available to you in your SocialApps.tech Client Area. Login into your SocialApps.tech Client Area here: <a href="https://socialapps.tech/user/login" target="_blank">https://socialapps.tech/user/login</a>.'); ?>
    <?php endif; ?>
</p><br />
...
<?php if ($this->flag_delete == 1) : ?>
    <div class="tip">
        <span>  
            ...
            echo $this->translate('You have installed the latest version of “SocialApps.tech Core Plugin”. So, please remove the old version installed on your site and its associated old “Socialengineaddon” directory, which is available at "/application/modules/Socialengineaddon" as we are now using “Seaocore” directory. To remove the old version and its directory, <a href="' . $this->url(array('action' => 'delete', 'modules' => $module_name)) . '" class="smoothbox">Click here</a>.');
            ?>
        </span>
    </div>
<?php elseif ($this->flag_delete == 2): ?>
    <div class="tip">
        <span>
            <?php echo $this->translate('You have installed the latest version of “SocialApps.tech Core Plugin”. So, please remove the old “Socialengineaddon” directory, which is available at "/application/modules/Socialengineaddon" as we are now using “Seaocore” directory.'); ?>
        </span>
    </div>
<?php endif; ?>
...
if (empty($isPlugin)):
    ?>
    <?php echo '<div class="tip"><span>No plugins by SocialApps.tech were found on your site. Click <a href="https://socialapps.tech/catalog/1/plugins" target="_blank">here</a> to view and purchase them.</span></div>'; ?>
<?php endif; ?>
