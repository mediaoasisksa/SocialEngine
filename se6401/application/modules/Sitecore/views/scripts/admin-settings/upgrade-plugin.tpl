 ...
 * @version    $Id: upgrade-plugin.tpl 2010-11-18 9:40:21Z SocialApps.tech $
...
<?php if( empty($this->setUpgradeUrl) || !empty($this->error) ): ?>
  ...
  <?php endif; ?>
<?php else: ?>
<?php $getUpgrade = $this->url(array('module' => 'sitecore', 'controller' => 'settings', 'action' => 'set-upgrade-url'), 'admin_default', true); ?>
  <script type="text/javascript">
