...
if( empty($this->unlicense_modules_array) ) {
  ...
  <style type="text/css">
    ...
    .global_form .form-sucess {
      margin-bottom:10px;
    }
    .global_form .form-sucess li {
...
<?php } else { ?>
  <style type="text/css">
    ...
    ul.form-not > li {
      background-image:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Seaocore/externals/images/error.png);
    ...
    <div>
      <div>
        <div><ul class="form-not"><li>
              ...
              <?php echo $this->translate('Unlicensed plugin(s) were detected on your site. You will not be able to install this plugin on your site till one of the below is done:<br /><br />1) Delete all unlicensed copies of SocialApps.tech plugins from your site.<br />2) Purchase valid plugin license(s) and enter the license key(s) in the Global Settings of those plugin(s) on your site.<br /><br />After completing any of these steps, you can try again to install this plugin from the "Manage Plugins" section. For any questions, please <a href="https://socialapps.tech/contact-us" target="_blank">contact SocialApps.tech</a>.');
              echo $this->translate('<br /><br />You are using unlicensed copies of the following plugin(s) on your site:');
              ?>
              <table>
                <?php
                foreach( $this->unlicense_modules_array as $modules_name ) {
  ...
  <?php echo '<a href="https://socialapps.tech/contact-us" target="_blank" class="button">Contact SocialApps.tech</a>'; ?>
