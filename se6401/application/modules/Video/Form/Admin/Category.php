 ...
 * @license    http://www.socialengine.com/license/
 */
class Video_Form_Admin_Category extends Engine_Form
{
  protected $_field;
  ...
  public function init()
  {
    ...
    */
    ...
    $categoryVideo = $videoTable->isVideoExists($category_id, 'category_id');
    $subcatVideo = $videoTable->isVideoExists($category_id, 'subcat_id');
    $subsubcatVideo = $videoTable->isVideoExists($category_id, 'subsubcat_id');
    
    if(engine_count($subcategory) == 0 && engine_count($subsubcategory) == 0 && empty($category->subsubcat_id) && empty($categoryVideo) && empty($subcatVideo) && empty($subsubcatVideo)) {
