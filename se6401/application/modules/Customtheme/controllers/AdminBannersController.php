 ...
 * @license    http://www.socialengine.com/license/
 */
class CustomTheme_AdminBannersController extends Core_Controller_Action_Admin
{

  public function indexAction()
  {
    $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
    ->getNavigation('customtheme_admin_main', array(), 'customtheme_admin_main_banners');

    $table = Engine_Api::_()->getDbTable('banners', 'customtheme');
  ...
  {
    $this->view->form = $form = new CustomTheme_Form_Admin_Banners_Create();
    // Check stuff
    ...
    $this->_helper->redirector->gotoRoute(array('module' => 'customtheme', 'controller' => 'banners'), 'admin_default', true);
  }

  public function editAction()
  {
    $this->view->banner_id = $bannerId = $this->_getParam('id');
    $this->view->banner = $banner = Engine_Api::_()->getDbtable('banners', 'customtheme')->getBanner($bannerId);
    if( !$banner ) {
      throw new Core_Model_Exception('missing banner');
    }

    $this->view->form = $form = new Hpbblock_Form_Admin_Banners_Edit();
  ...
  {
    $this->view->banner_id = $bannerId = $this->_getParam('id');
    $banner = Engine_Api::_()->getDbtable('banners', 'customtheme')->getBanner($bannerId);
    ...
    // Get form
    $this->view->form = $form = new Hpbblock_Form_Admin_Banners_Delete();
