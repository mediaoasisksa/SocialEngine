...
<div class="sesbasic_bxs mentor_view_cover">
	<div class="mentor_view_cover_top">
		<div class="mentor_view_cover_top_content">
			...
			<div class="_info">
				<?php if($this->profileType):?><span class="category custom_tag"><a href="/se6401/pages/mentor-service"><?php echo $this->translate($this->profileType);?></a></span><?php endif;?>
				<div class="_social">
	...
	<div class="mentor_view_cover_bottom_content">
		<div class="mentor_view_cover_bottom_left">	     
			...
			<p class="_ti"><i class="fas fa-edit"></i><span><a href="/se6401/members/edit/profile"><?php echo $this->translate("Edit Profile");?></a></span></p>
			<p class="_ti"><i class="fas fa-cog"></i><span><a href="/se6401/members/settings/general"><?php echo $this->translate("Settings");?></a></span></p>
			<p class="_ti"><i class="fas fa-sign-out-alt"></i><span><a href="/se6401/logout"><?php echo $this->translate("Logout");?></a></span></p>
			<?php endif;?>
		</div>
			...
			<ul>
				<li class="mentor_view_cover_bottom_right_service">
					...
					<div class="_options">
						...
						<a href="/se6401/sitebooking/service/disable/pro_id/<?php echo $this->dataMentor['parent_id']; ?>/id/<?php echo $this->dataMentor['ser_id']; ?>/format/smoothbox" class="_disabled smoothbox"><i class="fas fa-minus-circle"></i><span><?php echo $this->translate("Disable Service")?></span></a>
						
						<a href="/se6401/bookings/providers/available/<?php echo $this->dataConsultant['parent_id']; ?>?ser_id=<?php echo $this->dataMentor['ser_id']; ?>&isAjax=1"><i class="far fa-clock"></i><span><?php echo $this->translate("Set Booking Time")?></span></a>
					</div>
					<?php endif;?>
				</li>
				<li class="mentor_view_cover_bottom_right_service">
					<div class="_info">
						<h3><a href="/se6401/bookings/services/home"><?php echo $this->translate("Consulting Service")?></a></h3>
					...
					<div class="_options">
	                    <a href="/se6401/bookings/providers/<?php echo $this->dataConsultant['parent_id']; ?>/service/edit/<?php echo $this->dataConsultant['ser_id']; ?>"><i class="fas fa-pencil-alt"></i><span><?php echo $this->translate("Edit Service")?></span></a>
						<a href="/se6401/sitebooking/service/disable/pro_id/<?php echo $this->dataConsultant['parent_id']; ?>/id/<?php echo $this->dataConsultant['ser_id']; ?>/format/smoothbox" class="_disabled smoothbox"><i class="fas fa-minus-circle"></i><span><?php echo $this->translate("Disable Service")?></span></a>
						<a href="/se6401/bookings/providers/available/<?php echo $this->dataConsultant['parent_id']; ?>?ser_id=<?php echo $this->dataConsultant['ser_id']; ?>&isAjax=1"><i class="far fa-clock"></i><span><?php echo $this->translate("Set Booking Time")?></span></a>
					</div>
					<?php endif;?>
				</li>
			</ul>
