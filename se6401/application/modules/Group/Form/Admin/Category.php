...
class Group_Form_Admin_Category extends Engine_Form
{
  ...
  public function init()
  {
    ...
    $category = Engine_Api::_()->getItem('group_category', $category_id);
    ...
    */
    ...
    $categoryGroup = $groupTable->isGroupExists($category_id, 'category_id');
    $subcatGroup = $groupTable->isGroupExists($category_id, 'subcat_id');
    $subsubcatGroup = $groupTable->isGroupExists($category_id, 'subsubcat_id');
    
    if(engine_count($subcategory) == 0 && engine_count($subsubcategory) == 0 && empty($category->subsubcat_id) && empty($categoryGroup) && empty($subcatGroup) && empty($subsubcatGroup)) {
