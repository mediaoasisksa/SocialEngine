...
<script type="text/javascript">
 ...
 en4.core.runonce.add(function() {
  ...
  $('selectall').addEvent('click',function(){
    ...
    if(this.checked == true){
      for (var i = 0; i < all.length; ++i) {
        if($('label_'+all[i].id).style.display == 'none'){
          all[i].checked = false; 
        }else{
          all[i].checked = true;
        }
  ...
  $$('.timerange').addEvent('change',function(){
    ...
    var y2 = endtime*2;
      ...
      if(y2-y1 > 0) {
        if(z >= y1 && z <= y2 ){
          $('label_mon_'+z).style.display = "block";
          $('label_tue_'+z).style.display = "block";
          $('label_wed_'+z).style.display = "block";
          $('label_thu_'+z).style.display = "block";
          $('label_fri_'+z).style.display = "block";
          $('label_sat_'+z).style.display = "block";
          $('label_sun_'+z).style.display = "block";
          ...
          $('label_mon_'+z).style.display = "none";
          $('label_tue_'+z).style.display = "none";
          $('label_wed_'+z).style.display = "none";
          $('label_thu_'+z).style.display = "none";
          $('label_fri_'+z).style.display = "none";
          $('label_sat_'+z).style.display = "none";
          $('label_sun_'+z).style.display = "none";
          
          if($('selectall').checked == true){
            $('mon_'+z).checked = false;
            $('tue_'+z).checked = false;
            $('wed_'+z).checked = false;
            $('thu_'+z).checked = false;
            $('fri_'+z).checked = false;
            $('sat_'+z).checked = false;
            $('sun_'+z).checked = false;
          }
        }
      } else {
  ...
  $('sitebooking_services_options').addEvent('change', function(){
