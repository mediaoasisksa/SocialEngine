    ...
    <div class="_inner">
      ...
      <div class="_right">
        ...
        <div class="_providername">
            ...
            By       <?php echo $this->htmlLink(array('action' => 'view','user_id' => $item->owner_id,'pro_id' => $item->parent_id,'route' => 'sitebooking_provider_view','reset' => true,'slug' => $item->provider_slug), $item->provider_title) ?>
