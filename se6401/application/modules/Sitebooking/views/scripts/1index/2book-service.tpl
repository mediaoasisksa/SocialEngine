...
//       t[i].remove();
//     }
//     var catId = '<?php echo $this->service[0]->category_id;?>';
//     for (x in duration) {
//       if(catId == 2) { 
//                 var myDate = new Date(x);
// var result1 = "-to-" + dateFormat1(myDate.addMonths(1).toLocaleDateString(), 'yyyy-MM-dd');
//                 var y = x + result1;
...
//         $('price').remove();
//     }   
//     $('duration').value = JSON.stringify(duration);
//     $('servicing_date').value = servicingDate;
    
//     var myDate = new Date(servicingDate);
//     if(catId == 2) { 
//     $('servicing_end_date').value = dateFormat1(myDate.addMonths(1).toLocaleDateString(), 'yyyy-MM-dd');
//     }
//     $('total_charges').value = <?php echo $this->service[0]->price?>*count;
//   });
...
var result1 = "-to-" + dateFormat1(myDate.addMonths(1).toLocaleDateString(), 'yyyy-MM-dd');
    ...
    $('total_charges').value = '<?php echo $this->service[0]->price?>';
  $('time_button').addEvent('click',function(){
    $('avalable_calendar').style.display = "none";
    $('time_button').style.display = "none";
    $('desc_contact').style.display = "block";
    
    $('timezone_user').style.display = "none";
  ...
  $('next').addEvent('click',function(){
    ...
    $(dateFormat).style.display = 'inline-block';
