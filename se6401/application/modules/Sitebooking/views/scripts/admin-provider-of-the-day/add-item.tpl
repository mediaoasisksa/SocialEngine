...
<script type="text/javascript">
  ...
  {
    var contentAutocomplete = new Autocompleter.Request.JSON('title', '<?php echo $this->url(array('module' => 'sitebooking', 'controller' => 'provider-of-the-day', 'action' => 'getitem'), 'admin_default', true) ?>', {
      'postVar' : 'text',
      'minLength': 1,
      'selectMode': 'pick',
