...
<script type="text/javascript">
  ...
  function viewmore<?php echo $this->identity ?>() {
    en4.core.request.send(new Request.HTML({
      ...
      document.getElementById("similar_providers<?php echo $this->identity ?>").innerHTML = document.getElementById("similar_providers<?php echo $this->identity ?>").innerHTML + responseHTML;
      }     
    }));
