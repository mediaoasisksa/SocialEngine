 ...
 */
class Group_Api_Siteapi_FormValidators extends Siteapi_Api_Validators {
    ...
    public function getFormValidators($subject = array(), $formValidators = array()) {
        ...
        $formValidators['auth_invite'] = array(
            'required' => true,
            'allowEmpty' => false
        );
        ...
        $formValidators['auth_event'] = array(
            'required' => true,
            'allowEmpty' => false
        );
    ...
    /**
     * Validations of group photo edit form
     * 
     * @param object $subject get object
     * @param array $formValidators array variable
     * @return array
