...
class Group_Model_Photo extends Core_Model_Item_Collectible
{
    ...
    {
      return ($this->getParent()->getParent()->authorization()->isAllowed($user, 'photo_edit') || ($this->user_id == $user->getIdentity() && Engine_Api::_()->authorization()->isAllowed('group', $user, 'photo_edit')));
    }

    public function canDelete($user)
    {
       return ($this->getParent()->getParent()->authorization()->isAllowed($user, 'photo_delete') || ($this->user_id == $user->getIdentity() && Engine_Api::_()->authorization()->isAllowed('group', $user, 'photo_delete'))); 
    }
}
