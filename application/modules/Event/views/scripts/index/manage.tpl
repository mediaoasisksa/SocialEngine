...
<?php if( engine_count($this->paginator) > 0 ): ?>
  ...
  <div class='layout_middle'>
    <ul class='events_browse events_manage list_wrapper'>
      <?php foreach( $this->paginator as $event ): ?>
        <li>
          ...
          <div class="events_options">
            ...
            <?php echo $this->htmlLink(array('route' => 'event_specific', 'module' => 'event', 'controller' => 'event', 'action' => 'delete', 'event_id' => $event->getIdentity(), 'format' => 'smoothbox'), $this->translate('Delete Event'), array(
	    ...
	    <div class="events_members">
	      <?php echo $this->locale()->toDateTime($event->starttime) ?>
            ...
            <div class="events_members">
              <?php echo $this->translate(array('%s guest responses', '%s guest responses', $event->membership()->getMemberCount()),$this->locale()->toNumber($event->membership()->getMemberCount())) ?>
              <?php echo $this->translate('led by') ?>
              <?php echo $this->htmlLink($event->getOwner()->getHref(), $event->getOwner()->getTitle()) ?>
              <div class="events_members_rating">
