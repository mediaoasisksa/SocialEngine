...
class Event_Form_Admin_Category extends Engine_Form
{
  ...
  public function init()
  {
    ...
    $category = Engine_Api::_()->getItem('event_category', $category_id);
    ...
    */
    ...
    $categoryEvent = $eventTable->isEventExists($category_id, 'category_id');
    $subcatEvent = $eventTable->isEventExists($category_id, 'subcat_id');
    $subsubcatEvent = $eventTable->isEventExists($category_id, 'subsubcat_id');
    
    if(engine_count($subcategory) == 0 && engine_count($subsubcategory) == 0 && empty($category->subsubcat_id) && empty($categoryEvent) && empty($subcatEvent) && empty($subsubcatEvent)) {
