 ...
 * @license    http://www.socialengine.com/license/
 */
class Bizlist_Form_Admin_Category extends Engine_Form
{
  protected $_field;
  ...
  public function init()
  {
    ...
    $category = Engine_Api::_()->getItem('bizlist_category', $category_id);
    ...
    */
    ...
    $categoryBizlist = $bizlistTable->isBizlistExists($category_id, 'category_id');
    $subcatBizlist = $bizlistTable->isBizlistExists($category_id, 'subcat_id');
    $subsubcatBizlist = $bizlistTable->isBizlistExists($category_id, 'subsubcat_id');
    
    if(engine_count($subcategory) == 0 && engine_count($subsubcategory) == 0 && empty($category->subsubcat_id) && empty($categoryBizlist) && empty($subcatBizlist) && empty($subsubcatBizlist)) {
