 ...
 * @license    http://www.socialengine.com/license/
 */
class Bizlist_Form_Photo_Upload extends Engine_Form
{
  public function init()
  {
    ...
    $this
      ...
      ->setDescription('Choose photos on your computer to add to this business listing. (2MB maximum)')
      ->setAttrib('id', 'form-upload')
      ->setAttrib('class', 'global_form bizlist_form_upload')
