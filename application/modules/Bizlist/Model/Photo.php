 ...
 * @license    http://www.socialengine.com/license/
 */
class Bizlist_Model_Photo extends Core_Model_Item_Collectible
{
  protected $_parent_type = 'bizlist_album';

  protected $_owner_type = 'user';

  protected $_collection_type = 'bizlist_album';
  ...
  public function getHref($params = array())
  {
    $params = array_merge(array(
      ...
      'controller' => 'photo',
      'action' => 'view',
      'bizlist_id' => $this->getCollection()->getOwner()->getIdentity(),
  ...
  {
    return Engine_Api::_()->getItem('bizlist', $this->bizlist_id);
