 ...
 * @version    $Id: Bizlist.php 9747 2012-07-26 02:08:08Z john $
 * @author     Jung
 */
 ...
 * @license    http://www.socialengine.com/license/
 */
class Bizlist_Model_Bizlist extends Core_Model_Item_Abstract
{
  // Properties
  ...
  public function getHref($params = array())
  {
    ...
    $params = array_merge(array(
      'route' => 'bizlist_entry_view',
      'reset' => true,
      'user_id' => $this->owner_id,
      'bizlist_id' => $this->bizlist_id,
      'slug' => $slug,
    ), $params);
    $route = $params['route'];
    $reset = $params['reset'];
  ...
  public function setPhoto($photo)
  {
    if( $photo instanceof Zend_Form_Element_File ) {
      ...
      throw new Bizlist_Model_Exception('invalid argument passed to setPhoto');
    }
    ...
    $bizlistAlbum = $this->getSingletonAlbum();
    $photoItem = $photoTable->createRow();
    $photoItem->setFromArray(array(
      'bizlist_id' => $this->getIdentity(),
      'album_id' => $bizlistAlbum->getIdentity(),
      'user_id' => $viewer->getIdentity(),
      'file_id' => $iMain->getIdentity(),
      'collection_id' => $bizlistAlbum->getIdentity(),
    ));
    $photoItem->save();
  ...
  public function addPhoto($file_id){
    ...
    $photo = Engine_Api::_()->getDbtable('photos', 'bizlist')->createRow();
  ...
  {
    $table = Engine_Api::_()->getItemTable('bizlist_album');
    $select = $table->select()
      ->where('bizlist_id = ?', $this->getIdentity())
      ->order('album_id ASC')
      ->limit(1);
  ...
  public function getCategoryItem()
  {
      if(!$this->category_id)
        return false;
      return Engine_Api::_()->getItem('bizlist_category',$this->category_id);
  }
