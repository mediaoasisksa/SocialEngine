  ...
  en4.core.runonce.add(function() {
    new Uploader('#upload_file', {
      ...
      uploadLinkDesc : '<?php echo $this->translate("Click \"Add Photos\" to select one or more photos from your computer."
        ...
        . "When your upload is finished, click the button below your photo list to save them to your business listing.");?>'
    });
  });
</script>
<div class="layout_middle">
  <div class="generic_layout_container">
    <h2><?php echo $this->translate('Business Listing Photos');?></h2>
