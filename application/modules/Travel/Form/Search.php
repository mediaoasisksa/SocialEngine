 ...
 * @license    https://socialengine.com/eula
 */
class Travel_Form_Search extends Fields_Form_Search
{
  ...
  public function init()
  {
    ...
    $this
      ->setAttribs(array(
        'id' => 'filter_form',
        'class' => 'global_form_box travels_browse_filters field_search_criteria',
      ))
      ->setAction($_SERVER['REQUEST_URI'])
      ->setMethod('GET')
      ->getDecorator('HtmlTag')
        ->setOption('class', 'browsetravels_criteria travels_browse_filters');
  ...
  public function getAdditionalOptionsElement()
  {
    ...
    if(Engine_Api::_()->getApi('settings', 'core')->getSetting('travel.enable.rating', 1)) {
    ...
    $this->addElement('Checkbox', 'has_photo', array(
      'label' => 'Only Travel Listings With Photos',
      'order' => 10000000,
      'decorators' => array(
        'ViewHelper',
