 ...
 * @license    https://socialengine.com/eula
 */
class Travel_Model_Photo extends Core_Model_Item_Collectible
{
  protected $_parent_type = 'travel_album';

  protected $_owner_type = 'user';

  protected $_collection_type = 'travel_album';
  ...
  public function getHref($params = array())
  {
    $params = array_merge(array(
      ...
      'controller' => 'photo',
      'action' => 'view',
      'travel_id' => $this->getCollection()->getOwner()->getIdentity(),
  ...
  {
    return Engine_Api::_()->getItem('travel', $this->travel_id);
