 ...
 * @license    http://www.socialengine.com/license/
 */
class Employment_Form_Photo_Upload extends Engine_Form
{
  public function init()
  {
    ...
    $this
      ...
      ->setDescription('Choose photos on your computer to add to this employment listing. (2MB maximum)')
      ->setAttrib('id', 'form-upload')
      ->setAttrib('class', 'global_form employment_form_upload')
