 ...
 * @license    http://www.socialengine.com/license/
 */
class Employment_Form_Admin_Category extends Engine_Form
{
  protected $_field;
  ...
  public function init()
  {
    ...
    $category = Engine_Api::_()->getItem('employment_category', $category_id);
    ...
    */
    ...
    $categoryEmployment = $employmentTable->isEmploymentExists($category_id, 'category_id');
    $subcatEmployment = $employmentTable->isEmploymentExists($category_id, 'subcat_id');
    $subsubcatEmployment = $employmentTable->isEmploymentExists($category_id, 'subsubcat_id');
    
    if(engine_count($subcategory) == 0 && engine_count($subsubcategory) == 0 && empty($category->subsubcat_id) && empty($categoryEmployment) && empty($subcatEmployment) && empty($subsubcatEmployment)) {
