 ...
 * @license    http://www.socialengine.com/license/
 */
class Employment_Widget_HashtagSearchResultsController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        if(!Engine_Api::_()->authorization()->getPermission($levelId, 'employment', 'view')) 
          return $this->setNoRender();
          
        $tag = Zend_Controller_Front::getInstance()->getRequest()->getParam('search', null);

        $widgetId = Engine_Api::_()->getDbTable('content', 'core')->widgetId('employment.hashtag-search-results', 'core_hashtag_index');
        ...
        // Get paginator
        $this->view->paginator = $paginator = Engine_Api::_()->getItemTable('employment')->getEmploymentsPaginator(array(
