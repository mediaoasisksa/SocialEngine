...
<div class="employment_list_widget">
    ...
    <?php foreach( $this->paginator as $item ): ?>
      <li>
        ...
        <div class="employment_list_widget_date">
          ...
          - <?php echo $this->translate('posted by %1$s', $this->htmlLink($item->getOwner()->getHref(), $item->getOwner()->getTitle())) ?>
        </div>
  ...
  <?php if( $this->paginator->getPages()->pageCount > 1 ): ?>
    <div class="employment_list_widget_more">
      <?php echo $this->partial('_widgetLinks.tpl', 'core', array('url' => $this->url(array('action' => 'index'), 'employment_general', true),'param' => array('orderby' => 'creation_date'))); ?>
    </div>
  <?php endif; ?>
</div>
