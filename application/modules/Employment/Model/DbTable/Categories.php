 ...
 * @license    http://www.socialengine.com/license/
 */
class Employment_Model_DbTable_Categories extends Engine_Db_Table
{
  protected $_rowClass = 'Employment_Model_Category';
  ...
  public function getUserCategoriesAssoc($user)
  {
    ...
    $stmt = $this->getAdapter()
        ->select()
        ->from('engine4_employment_categories', array('category_id', 'category_name'))
        ->joinLeft('engine4_employment_employments', "engine4_employment_employments.category_id = engine4_employment_categories.category_id")
        ->group("engine4_employment_categories.category_id")
        ->where('engine4_employment_employments.owner_id = ?', $user)
        ->where('engine4_employment_employments.draft = ?', "0")
        ->order('category_name ASC')
        ->query();
