 ...
 * @license    http://www.socialengine.com/license/
 */
class Employment_Model_Photo extends Core_Model_Item_Collectible
{
  protected $_parent_type = 'employment_album';

  protected $_owner_type = 'user';

  protected $_collection_type = 'employment_album';
  ...
  public function getHref($params = array())
  {
    $params = array_merge(array(
      ...
      'controller' => 'photo',
      'action' => 'view',
      'employment_id' => $this->getCollection()->getOwner()->getIdentity(),
  ...
  {
    return Engine_Api::_()->getItem('employment', $this->employment_id);
