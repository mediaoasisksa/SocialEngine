...
//var extraData = {"employment_id":15};
		...
		onFileStart: function() {
		  ...
		  file_id = file.photo_id;
                  request = new Request.JSON({
                   'format' : 'json',
                   'url' : '<?php echo $this->url(Array('module'=>'employment', 'controller' => 'photo', 'action'=>'remove'), 'default') ?>',
                   'data': {
                     'photo_id' : file_id
                   },
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('Click "Add Photos" to select one or more photos from your computer. After you have selected the photos, they will begin to upload right away. When your upload is finished, click the button below your photo list to save them to your employment listing.');?>
  </div>
  <div>
