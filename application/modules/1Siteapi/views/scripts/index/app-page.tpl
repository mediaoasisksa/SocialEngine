...
<div class="siteapi-cont-body-bg">
  <div class="siteapi-cont-lf">
    ...
    <div class="siteapi-icon-title">
        <?php echo '<a class="" href="' . $this->androidCallingURL . '"><img src="" alt="'.$this->iosAppBuilderParams['title'].'"/></a>'; ?>
        <?php } if (isset($this->hasIosApp) && !empty($this->hasIosApp)){ ?>
        <?php echo '<a class="" href="' . $this->iosCallingURL . '"><img src="" alt="'.$this->iosAppBuilderParams['title'].'"/></a>'; ?>
    </div>
  </div>
