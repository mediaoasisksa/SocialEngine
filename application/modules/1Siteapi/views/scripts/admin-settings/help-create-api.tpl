        ...
        <ul class="admin_seaocore_guidelines" id="siteapi-config">
            ...
            <li>
                <div class="steps">
                    ...
                    <div id="siteapistep-<?php echo $flag; ?>" style='display: none;'>                        
                        <p>
                            To access the API actions, create the desired API routes in /application/modules/MODULENAME/settings/manifest.php file.
                            <br /><br />
                            <!--Add step4_1 image-->
