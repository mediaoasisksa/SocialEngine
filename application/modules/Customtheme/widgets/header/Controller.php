 ...
 * @license    http://www.socialengine.com/license/
 */
class Customtheme_Widget_HeaderController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
   ...
   $this->view->navigation = $navigation = Engine_Api::_()
    ...
    $this->view->navigationMini = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('core_mini');
