       ...
       <div class="forum_topic_title_wrapper">
        ...
        <?php elseif($isForumModerator): ?>
          <div class="forum_topic_options">
            ...
            <?php endif; ?>
            <?php echo $this->htmlLink(array('action' => 'rename', 'reset' => false), $this->translate('Rename'), array('class' => 'buttonlink smoothbox icon_forum_post_rename')) ?>
            <?php echo $this->htmlLink(array('action' => 'move', 'reset' => false), $this->translate('Move'), array('class' => 'buttonlink smoothbox icon_forum_post_move')) ?>

            <?php echo $this->htmlLink(array('action' => 'delete', 'reset' => false), $this->translate('Delete'), array('class' => 'buttonlink smoothbox icon_forum_post_delete')) ?>
          </div>
        <?php endif; ?>
        </div>
        <?php if( $this->topic->closed ): ?>
          ...
          <li id="forum_post_<?php echo $post->post_id ?>" class="forum_nth_<?php echo $i % 2 ?><?php if( $isModeratorPost ): ?> forum_moderator_post<?php endif ?>">
            ...
            <div class="forum_topic_posts_info">
              ...
              <div class="rich_content_body forum_topic_posts_info_body">
                ...
                echo Engine_Api::_()->core()->smileyToEmoticons($body);
                ?>
