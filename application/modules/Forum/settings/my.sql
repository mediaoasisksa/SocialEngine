...
(1, 'General', '', NOW(), NOW(), 1, 3),
(2, 'Off-Topic', '', NOW(), NOW(), 2, 2);
...
('core_main_forum', 'forum', 'Forum', '', '{"route":"forum_general","icon":"fa fa-comments"}', 'core_main', '', 5),
('core_sitemap_forum', 'forum', 'Forum', '', '{"route":"forum_general"}', 'core_sitemap', '', 5),

('core_admin_main_plugins_forum', 'forum', 'Forums', '', '{"route":"admin_default","module":"forum","controller":"manage"}', 'core_admin_main_plugins', '', 999),
...
('forum', 'Forums', 'Forums', '4.8.11', 1, 'extra');
...
('forum_topic_response', 'forum', '{item:$subject} has {item:$postGuid:posted} on a {item:$object:forum topic} you created.', 0, ''),
('forum_topic_reply', 'forum', '{item:$subject} has {item:$postGuid:posted} on a {item:$object:forum topic} you posted on.', 0, ''),
