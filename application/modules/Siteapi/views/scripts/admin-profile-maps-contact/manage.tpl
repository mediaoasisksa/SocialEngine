...
<?php if (!Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled("suggestion")):?>
  <div class="seaocore_tip">
      <span>
        <?php echo $this->translate("Note: Please enable Suggestions Plugin OR Peopleyoumayknow Plugin by SocialApps.tech, so that Sync Profile Fields funtion properly.");?>
    </span>
  </div>
<?php else: ?>
