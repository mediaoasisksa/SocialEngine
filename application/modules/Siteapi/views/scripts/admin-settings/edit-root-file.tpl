...
<div class="global_form_popup">
    ...
    <p>
        ...
        <i><span style="font-weight: bold">define('_ENGINE_R_TARG', 'index.php');</span></i>
    </p>
<br />
    <p>
        <span style="font-weight: bold">Step 3:</span> Replace the above code with the below code:<br />
...
<br />
    <p>
        <span style="font-weight: bold">Step 4:</span> You have successfully modified your Root File, API calling is now enabled and started for your website.
    </p>
    <br />
