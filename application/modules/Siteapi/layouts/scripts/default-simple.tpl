...
<head>
  ...
  <script type="text/javascript">
    ...
    en4.core.loader = scriptJquery.crtEle('img', {src: en4.core.staticBaseUrl + 'application/modules/Seaocore/externals/images/loading.gif'});
  ...
  <?php
    $this->headScript()
      ...
      ->prependFile($staticBaseUrl . 'externals/mdetect/mdetect.js'); // custom work starts, end
    // Process
