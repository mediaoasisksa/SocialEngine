 ...
 * @author     John
 */
class Siteapi_View_Helper_Fields_FieldMultiselect extends Siteapi_View_Helper_Fields_FieldAbstract
{
  public function fieldMultiselect($subject, $field, $value, $view)
  {
    // Build values
    $vals = array();
