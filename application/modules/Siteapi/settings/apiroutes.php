...
$routes['siteapi'] = array(
    'applog' => array(
        'route' => 'app-log/:action/*',
        'defaults' => array(
            'module' => 'siteapi',
            'controller' => 'applog',
            'action' => 'write',
...
$routes['blog'] = array(
    'blog_general' => array(
        ...
        'reqs' => array(
            'action' => '(index|create|manage|tag|upload-photo|browse|search-form|category|subscribe|unsubscribe)',
        ),
    ),
    'blog_specific' => array(
...
$routes['advancedactivity'] = array(
    'advancedactivity_index_general' => array(
        ...
        'reqs' => array(
            'action' => '(edit-feed|comment|update-save-feed|delete|update-commentable|update-shareable|like|unlike|add-comment-notifications|compose-upload|send-like-notitfication|turn-on-off-notification|pin-unpin)',
        ),
    ),
    'advancedactivity_feed_general' => array(
        ...
        'reqs' => array(
            'action' => '(index|post|hide-item|un-hide-item|likes-comments|attach-link|open-close|feed-decoration|on-this-day|feed-post-menus|follow|edit-hide-options)',
        ),
    ),
    ...
    'advancedactivity_feeling_general' => array(
        'route' => 'advancedactivity/feelings/:action/*',
        'defaults' => array(
            'module' => 'advancedactivity',
            'controller' => 'feeling',
            'action' => 'getpre-choices',
        ),
        'reqs' => array(
            'action' => '(getpre-choices|banner|get-status-form|greeting-manage)',
        ),
    ),
);
...
$routes['activity'] = array(
    'notification_api_general' => array(
        ...
        'reqs' => array(
            'action' => '(notifications|friend-request|new-updates|hide|markread|mark-notification-show|mark-friend-request-read)',
        ),
    ),
...
$routes['album'] = array(
    ...
    'album_specific_changeprivacy' => array(
...
$routes['core'] = array(
    ...
    'api_error_content' => array(
        'route' => 'get-error-layout/*',
        'defaults' => array(
            'module' => 'core',
            'controller' => 'index',
    ...
    'api_profilephoto_menus' => array(
        'route' => 'get-profile-photo-menus/*',
        'defaults' => array(
            'module' => 'core',
            'controller' => 'index',
            'action' => 'get-profile-photo-menus',
        )
    ),
    'api_remove_profilephoto' => array(
    ...
    'get_server_settings' => array(
        'route' => 'get-server-settings/*',
        'defaults' => array(
            'module' => 'core',
            'controller' => 'index',
            'action' => 'get-server-settings',
        )
    ),
        'api_error_content' => array(
        'route' => 'get-error-layout/*',
    ...
    'core_api_global_settings' => array(
        'route' => 'get-settings/*',
        'defaults' => array(
            'module' => 'core',
            'controller' => 'index',
...
if($authObject){
    ...
    $module_name = 'communityad';

$routes[$module_name] = array(
...
'user_email_verification' => array(
    ...
    'api_user_profile_tab' => array(
        'route' => 'user/user-profile-tab/:user_id/*',
        'defaults' => array(
            'module' => 'user',
            'controller' => 'profile',
            'action' => 'user-profile-tab   ',
        )
    ),
    
    'api_user_member_info' => array(
        'route' => 'members/profile/get-member-info/*',
        'defaults' => array(
            'module' => 'user',
            'controller' => 'profile',
    ...
    'api_user_name_validation' => array(
        'route' => 'username-validation/*',
        'defaults' => array(
            'module' => 'user',
            'controller' => 'signup',
            'action' => 'username-validation',
        )
    ),
...
$routes['sitestore'] = array(
    'sitestore_general' => array(
        ...
        'reqs' => array(
            'action' => '(browse|search-form|manage|create|category)',
        ),
    ),
    'sitestore_specific' => array(
        ...
        'reqs' => array(
            'action' => '(view|close|delete|information|overview|album|offers|tellafriend|invite|payment-info|set-store-gateway-info|add-shipping-method|edit|edit-shipping-method|shipping-methods|delete-shipping-method|shipping-method-enable)',
        ),
    ),
    ...
    'sitestore_manageorder' => array(
        ...
        'reqs' => array(
            'action' => '(index|downloadable-files|search-form|increment-download|download|my-store-order)',
        ),
    ),
    ...
    'sitestore_package' => array(
        'route' => 'sitestore/package/:action/*',
        'defaults' => array(
            'module' => 'sitestore',
            'controller' => 'package',
            'action' => 'index'
        ...
        'reqs' => array(
            'action' => '(index|packages|upgrade-package)',
        ),
    ),
);
...
$routes['sitestoreproduct'] = array(
    'sitestoreproduct_search' => array(
        ...
        'reqs' => array(
            'action' => '(product-search-form|category|variation-option|make-order|getcombination|create|suggestproducts)',
        ),
    ),
    'sitestoreproduct_product' => array(
        ...
        'reqs' => array(
            'action' => '(add-to-wishlist|view|edit|delete|overview)',
            'product_id' => '\d+',
        ),
    ),
    ...
    'sitestoreproduct_browse' => array(
        ...
        'reqs' => array(
            'action' => '(browse|validate-product|browse-wishlist|create-wishlist|manage)',
        ),
    ),
    ...
    'sitestoreproduct_file_general' => array(
        'route' => 'sitestore/product/file/:action/:product_id/*',
        'defaults' => array(
            'module' => 'sitestoreproduct',
            'controller' => 'files',
            'action' => 'upload-file',
         ...
         'reqs' => array(
            'action' => '(upload-file|manage|edit|delete|enable-disable|download)',
            'product_id' => '\d+',
        ),
    ),
    
     'sitestoreproduct_photo_general' => array(
...
$routes['sitepage'] = array(
    'sitepage_specific' => array(
        ...
        'reqs' => array(
            'action' => '(view|edit|index|delete|close|publish|claim|messageowner|tellafriend|information|follow|overview|get-contact)',
            // 'page_id' => '\d+',
        ),
    ),
...
$routes['siteevent'] = array(
    'siteevent_general' => array(
        ...
        'reqs' => array(
            'action' => '(manage|create|search-form|map|categories|calender|packages|get-hosts|upgrade-package|events-integration)',
        ),
    ),
...
$routes['siteeventticket'] = array(
    ...
    'siteeventticket_ticket' => array(
        ...
        'reqs' => array(
            'action' => '(index|trends|tickets-buy|member-list)'
        ),
    ),
...
$routes['sitecontentcoverphoto'] = array(
    'sitecontentcoverphoto_general' => array(
        ...
        'reqs' => array(
            'action' => '(upload-cover-photo|remove-cover-photo|get-cover-photo-menu|get-albums-photos)'
        ),
    ),
);
...
$routes['nestedcomment'] = array(
    ...
    'nestedcomment' => array(
        ...
        'reqs' => array(
            'action' => '(add-comment-notifications|comment|send-like-notitfication|like|likes-comments|reply|reply-edit|comment-edit|update|likes-commentsall)'
        ),
    ),
);
...
$routes['siteverify'] = array(
    'siteverify_general' => array(
        'route' => 'memberverify/:action/*',
        'defaults' => array(
            'module' => 'siteverify',
            'controller' => 'index',
            'action' => 'verify-detail',
        ),
        'reqs' => array(
            'action' => '(allow-verify|edit-verify|cancel-verify|verify-detail|verify)'
        ),
    ),
);

$routes['sitecrowdfunding'] = array(
    'sitecrowdfunding_general' => array(
        'route' => 'crowdfunding/:action/*',
        'defaults' => array(
        ...
        'reqs' => array(
            'action' => '(browse|manage|create|packages|upgrade-package|category|search-form|project-owner-faq|backer-faq|user-full-bio)'
        ),
    ),
    
    'sitecrowdfunding_specific' => array(
        'route' => 'crowdfunding/:action/:project_id/*',
        'defaults' => array(
            'module' => 'sitecrowdfunding',
            'controller' => 'project',
            'action' => 'view',
        ...
        'reqs' => array(
            'action' => '(edit|view|delete|payment-info|set-project-gateway-info|favourite)'
        ),
    ),
    'sitecrowdfunding_profiletab' => array(
        'route' => 'crowdfunding/profiletab/:action/:project_id/*',
        'defaults' => array(
            'module' => 'sitecrowdfunding',
        ...
        'reqs' => array(
            'action' => '(information|overview|backers|photo|upload-photo|about-you)'
        ),
    ),
    
    'sitecrowdfunding_reward' => array(
        'route' => 'crowdfunding/reward/:action/:project_id/*',
        'defaults' => array(
            'module' => 'sitecrowdfunding',
            'controller' =>'reward',
            'action' => 'create',
        ...
        'reqs' => array(
            'action' => '(create|edit|manage|browse|view-shipping-locations|delete)'
        ),
    ),
    
    'sitecrowdfunding_leader' => array(
        'route' => 'crowdfunding/leader/:action/:project_id/*',
        'defaults' => array(
            'module' => 'sitecrowdfunding',
            'controller' =>'leader',
        ...
        'reqs' => array(
            'action' => '(manage-leaders|add-leader|remove|leader-auto-suggest)'
        ),
    ),
    
    'sitecrowdfunding_backer' => array(
        'route' => 'crowdfunding/backer/:action/:project_id/*',
        'defaults' => array(
            'module' => 'sitecrowdfunding',
            'controller' =>'backer',
        ...
        'reqs' => array(
            'action' => '(reward-selection|checkout|place-order|view-backed-details)'
        ),
    ),
);
$routes['siteotpverifier'] = array(
    'siteotpverifier_general' => array(
        'route' => 'otpverifier/:action/*',
        'defaults' => array(
            'module' => 'siteotpverifier',
            'controller' => 'auth',
            'action' => 'verify-mobileno',
        ),
        'reqs' => array(
            'action' => '(verify-mobileno|send|add-mobileno|edit-mobileno|delete-mobileno|verify-otp|enable-verification|code-verification|forgot-password|verify|reset)'
        ),
    ),
    
);

$routes['sitegifplayer'] = array(
    'sitegifplayer_general' => array(
        'route' => 'gifplayer/:action/*',
        'defaults' => array(
            'module' => 'sitegifplayer',
            'controller' => 'index',
            'action' => 'load-gif',
        ),
        'reqs' => array(
            'action' => '(load-gif|my-gif|gif-settings|search)'
        ),
    ),
    
);

$routes['livestreamingvideo'] = array(
    'Livestreamingvideo_api_general' => array(
        'route' => 'livestreamingvideo/:action/*',
        'defaults' => array(
            'module' => 'livestreamingvideo',
            'controller' => 'index',
            'action' => 'start-video-streaming',
        ),
        'reqs' => array(
            'action' => '(start-video-streaming|stop-video-streaming|stop-stream|get-settings|delete|is-live|share-video|get-reactions)'
        ),
    ),
    );
// Add SiteQuickSignup Plugin APIs Routes
$routes['sitequicksignup'] = array(
    'sitequicksignup_api_general' => array(
        'route' => 'sitequicks/:action/*',
        'defaults' => array(
...
$routes['sitestories'] = array(
    'advancedactivity_story_general' => array(
        'route' => 'advancedactivity/stories/:action/*',
        'defaults' => array(
            'module' => 'sitestories',
            'controller' => 'story',
            'action' => 'browse',
        ...
        'reqs' => array(
            'action' => '(browse|create|mutestory-browse|banner|suggest||stories-privacy)',
        ),
    ),
    'advancedactivity_story_specific' => array(
        'route' => 'advancedactivity/story/:action/:story_id/*',
        'defaults' => array(
            'module' => 'sitestories',
            'controller' => 'story',
            'action' => 'view',
        ...
        'reqs' => array(
            'story_id' => '\d+',
            'action' => '(view|get-viewer|delete|edit|viewer-count|mute-story|report-story|view-replies)',
        ),
    )
);

$routes['sitedeeplinking'] = array(
'core_api_deeplinking' => array(
        'route' => 'deep-linking/*',
        'defaults' => array(
            'module' => 'sitedeeplinking',
            'controller' => 'index',
            'action' => 'deep-linking',
        )
    ),
...
$routes['sitemulticurrency'] = array(
'sitemulticurrency_api_general' => array(
        'route' => 'currencies/:action/*',
        'defaults' => array(
            'module' => 'sitemulticurrency',
            'controller' => 'index',
            'action' => 'currency',
        ),
    'reqs' => array(
            'action' => '(currency|manage-rates)',
        ),
    ),
 );
    
$routes['sitebooking'] = array(
'provider_general' => array(
        ...
        'reqs' => array(
            'action' => '(index|create|manage|search-form|delete-photo|provider-wishlist)',
        ),
    ),
    'provider_specific' => array(
        'route' => 'provider/:action/:pro_id/*',
        'defaults' => array(
            'module' => 'sitebooking',
            'controller' => 'serviceprovider',
            'action' => 'view',
        ...
        'reqs' => array(
            'action' => '(view|edit|tellafriend|enable|disable|services|information|photos|review|upload-photo|overview|remove-cover-photo|remove-photo|get-photo-menus|upload-cover-photo|upload-profile-photo|upload-profile-photo)',
        ),
    ),
    'booking_review' => array(
    ...
    'service_specified' => array(
        'route' => 'service/:action/:ser_id/*',
        'defaults' => array(
            'module' => 'sitebooking',
            'controller' => 'service',
            'action' => 'view',
        ...
        'reqs' => array(
            'action' => '(view|edit|tellafriend|delete|overview|information)',
        ),
    ),
    'service_general' => array(
        ...
        'reqs' => array(
            'action' => '(index|create|manage|search-form|service-wishlist)',
        ),
    ),
);

$routes['calendar'] = array(
    'calendar_general' => array(
        'route' => 'calendars/:action/*',
        'defaults' => array(
            'module' => 'calendar',
            'controller' => 'index',
            'action' => 'index',
        ...
        'reqs' => array(
            'action' => '(index|create|manage|getusers|manageschedule|get-members|claimCalendars|browse-schedules|claim|status|browse-schedules-date|test|calendar-list|owncalendars)',
        ),
    ),
    'calendar_specific' => array(
        ...
        'reqs' => array(
            'calendar_id' => '\d+',
            'action' => '(delete|edit|ical|view|claim|claimed-requests|status|add-owners|remove-owner|get-owners)',
        ),
    ),
    'calendar_group_general' => array(
        'route' => 'calendar-groups/:action/*',
        'defaults' => array(
            'module' => 'calendar',
            'controller' => 'group',
            'action' => 'index',
        ...
        'reqs' => array(
            'action' => '(index|create|manage|getusers|tag|upload-photo|suggest-member)',
        ),
    ),
    'calendar_group_specific' => array(
        'route' => 'calendar-group/:action/:group_id/*',
        'defaults' => array(
            'module' => 'calendar',
            'controller' => 'group',
            'action' => 'view',
        ...
        'reqs' => array(
            'group_id' => '\d+',
            'action' => '(delete|edit|view|add-members|remove-member)',
        ),
    ),
    'schedule_specific' => array(
        ...
        'reqs' => array(
            'schedule_id' => '\d+',
            'action' => '(import-schedules|edit|delete|update|move)',
        ),
    ),
    'schedule_general' => array(
        ...
        'reqs' => array(
            // 'group_id' => '\d+',
            'action' => '(create|get-schedules|suggest|get-schedules-date|manage)',
        ),
    ),
);
