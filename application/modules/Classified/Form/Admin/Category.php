 ...
 * @license    http://www.socialengine.com/license/
 */
class Classified_Form_Admin_Category extends Engine_Form
{
  protected $_field;
  ...
  public function init()
  {
    ...
    */
    ...
    $categoryClassified = $classifiedTable->isClassifiedExists($category_id, 'category_id');
    $subcatClassified = $classifiedTable->isClassifiedExists($category_id, 'subcat_id');
    $subsubcatClassified = $classifiedTable->isClassifiedExists($category_id, 'subsubcat_id');
    
    if(engine_count($subcategory) == 0 && engine_count($subsubcategory) == 0 && empty($category->subsubcat_id) && empty($categoryClassified) && empty($subcatClassified) && empty($subsubcatClassified)) {
