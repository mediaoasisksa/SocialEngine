 ...
 * @license    http://www.socialengine.com/license/
 */
class Music_Form_Admin_Category extends Engine_Form
{
  protected $_field;
  ...
  public function init()
  {
    ...
    $category = Engine_Api::_()->getItem('music_category', $category_id);
    ...
    */
    ...
    $musicTable = Engine_Api::_()->getDbTable('playlists', 'music');
    ...
    $categoryMusic = $musicTable->isMusicExists($category_id, 'category_id');
    $subcatMusic = $musicTable->isMusicExists($category_id, 'subcat_id');
    $subsubcatMusic = $musicTable->isMusicExists($category_id, 'subsubcat_id');
    
    if(engine_count($subcategory) == 0 && engine_count($subsubcategory) == 0 && empty($category->subsubcat_id) && empty($categoryMusic) && empty($subcatMusic) && empty($subsubcatMusic)) {
