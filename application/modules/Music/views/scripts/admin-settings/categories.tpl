...
<script type="application/javascript">
  ajaxurl = en4.core.baseUrl+"admin/music/settings/change-order";
</script>
...
<div class='admin-categories-form'>
  <div>
    <div class="admin-form-cont">
      <h3><?php echo $this->translate("Music Playlist Categories") ?> </h3>
      <p class="description"><?php echo $this->translate('MUSIC_VIEW_SCRIPTS_ADMINSETTINGS_CATEGORIES_DESCRIPTION'); ?></p>
            ...
            <div class="admin-form-field-element">
              <select name="parent" id="parent" class="postform">
                ...
                <?php foreach ($this->categories as $category): ?>
                  ...
                  <?php 
                    $subcategory = Engine_Api::_()->getDbtable('categories', 'music')->getSubcategory(array('column_name' => "*", 'category_id' => $category->category_id));          
          ...
          <table class='admin_table' style="width: 100%;">
            ...
            <tbody>
              ...
              <tr id="categoryid-<?php echo $category->category_id; ?>" data-id="<?php echo $category->category_id; ?>">
                ...
                <td>
                  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'music', 'controller' => 'settings', 'action' => 'edit-category', 'id' => $category->category_id), $this->translate('Edit'), array('class' => 'smoothbox')) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$category->category_id)); ?>
                </td>
              </tr>
              <?php //Subcategory Work
                ...
                foreach ($subcategory as $subCategory):  ?>
                  <tr id="categoryid-<?php echo $subCategory->category_id; ?>" data-id="<?php echo $subCategory->category_id; ?>">
                    ...
                    <td>
                      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'music', 'controller' => 'settings', 'action' => 'edit-category', 'id' => $subCategory->category_id), $this->translate('Edit'), array('class' => 'smoothbox')) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$subCategory->category_id)) ?>
                    </td>
                  </tr>
                  <?php //SubSubcategory Work
                  $subsubcategory = Engine_Api::_()->getDbtable('categories', 'music')->getSubsubcategory(array('column_name' => "*", 'category_id' => $subCategory->category_id));
                  foreach ($subsubcategory as $subsubCategory): ?>
                    <tr id="categoryid-<?php echo $subsubCategory->category_id; ?>" data-id="<?php echo $subsubCategory->category_id; ?>">
                      ...
                      <td>
                        <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'music', 'controller' => 'settings', 'action' => 'edit-category', 'id' => $subsubCategory->category_id), $this->translate('Edit'), array('class' => 'smoothbox')) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$subsubCategory->category_id)) ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                <?php endforeach; ?>
