 ...
 * @license    http://www.socialengine.com/license/
 */
class Music_Model_DbTable_Categories extends Engine_Db_Table
{
  protected $_rowClass = 'Music_Model_Category';
  ...
  public function getUserCategoriesAssoc($user)
  {
    ...
    $stmt = $this->getAdapter()
        ->select()
        ->from('engine4_music_categories', array('category_id', 'category_name'))
        ->joinLeft('engine4_music_playlists', "engine4_music_playlists.category_id = engine4_music_categories.category_id")
        ->group("engine4_music_categories.category_id")
        ->where('engine4_music_playlists.owner_id = ?', $user)
