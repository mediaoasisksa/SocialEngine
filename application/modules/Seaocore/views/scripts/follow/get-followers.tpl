...
<script type="text/javascript">
  ...
  function show_myfriend () {
    scriptJquery('#likes_popup_content').html('<center><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Seaocore/externals/images/load.gif" /></center>');
    ...
    var request = scriptJquery.ajax({
        ...
        success : function(responseHTML) {
          document.getElementById('likes_popup_content').html(responseHTML);
    ...
    en4.core.runonce.add(function() {
      ...
      document.getElementById('like_members_search_input').addEventListener('keyup', function(e) {
        scriptJquery('#likes_popup_content').html('<center><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Seaocore/externals/images/load.gif" alt="" style="margin-top:10px;" /></center>');
    ...
    var paginateLikeMembers = function(page, call_status) {
      var search_value = scriptJquery('#like_members_search_input').value;
      if (search_value == '') {
        search_value = '';
      }
    ...
    var likedStatus = function(call_status) {
      var request = scriptJquery.ajax({
        ...
        success : function(responseHTML) {
          document.getElementById('like_members_profile').parent().innerHTML = responseHTML;
          en4.core.runonce.trigger();
        }
      });
  }
