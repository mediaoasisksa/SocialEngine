...
<script type="text/javascript">
 ...
 var url = en4.core.baseUrl + 'seaocore/like/likelist';// URL where send ajax request.
    ...
    scriptJquery('#like_members_search_input').addEvent('keyup', function(e) {
		...
		<div class="top">
			<?php 
				...
				elseif($this->resource_type == 'list_listing' || $this->resource_type == 'sitereview_listing') {
					...
					$module_name = 'recipe';
				} elseif($this->resource_type == 'album_photo') {
					$module_name = 'photo';
					...
					$module_name = 'Channel';
                                ...
                                elseif($this->resource_type == 'video') {
					$module_name = 'Video';
				}
                                elseif($this->resource_type == 'forum_topic') {
					$module_name = 'Forum Topic';
				} elseif($this->resource_type == 'forum_post') {
					$module_name = 'Forum Post';
				} else {
