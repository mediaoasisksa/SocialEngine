...
echo '<div class="sitepage_grid_footer"><div><a href="javascript:void(0);"  class="sitepage_share_links_toggle"><span class="seao_icon_share"></span>' . $this->translate('Share') . '</a>'
. '<div class="sitepage_share_links" style="display:none;"><ul class="dropdown-menu social-share tall-review-box-menu">'
