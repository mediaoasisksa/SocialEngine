...
<form method="post" class="global_form_popup">
  <div>
    ...
    <p><?php echo $this->translate("Are you sure that you want to completely remove the old version of “SocialApps.tech Core Plugin” and its associated directory installed on your site? If you have done any customization work, then you can take the backup of this plugin."); ?></p>
    <br />
