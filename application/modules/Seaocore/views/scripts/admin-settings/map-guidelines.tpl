          ...
          <div class="steps">
            ...
            <div id="step-1" style='display: none;'>
              <p>
						   ...
						   <?php echo $this->translate("A) Go to this URL for steps to configure Google Places API key for your SocialEngine website:");?> <a href="https://youtu.be/YZuHAgmcat4" target="_blank" style="color:#5BA1CD;">https://youtu.be/YZuHAgmcat4</a><br /><br /> 
               <?php echo $this->translate("B) To start using Google APIs console go here :");?> <a href="https://code.google.com/apis/console" target="_blank" style="color:#5BA1CD;">https://code.google.com/apis/console</a> <br /><br /> 
               <?php echo $this->translate("(C) Associating a Billing Account is mandatory in order to configure the API and website should be running on https."); ?>
              </p>		
            </div>
          </div>
        </li>
