...
<script type="text/javascript">
  ...
  window.addEventListener('DOMContentLoaded',function(){
    ...
    // scrollGetDirection= SEAOMooVerticalScroll('panel-content-area', 'panel-scroll', {} );
    ...
    <?php else: ?>
        if (navigator.geolocation) { 
          navigator.geolocation.getCurrentPosition(function(position){        
            if(!position.address){
              var mapDetect=  new google.maps.Map(document.createElement('div'), {
                mapTypeId: google.maps.MapTypeId.ROADMAP, 
...
//    }
  ...
  var  toggoleDirectionContent= function(){
    scriptJquery('#panel-content-area').toggle();
    if(document.getElementById('collapse_hide').style.display == 'none'){
      document.getElementById('collapse_show').style.display ='none';
      document.getElementById('collapse_hide').style.display ='inline-block';
    }else{
      document.getElementById('collapse_show').style.display ='inline-block';
      document.getElementById('collapse_hide').style.display ='none';
    }
  };
