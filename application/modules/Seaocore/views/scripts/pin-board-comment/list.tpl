...
<script type="text/javascript">
  en4.core.runonce.add(function(){
    scriptJquery(scriptJquery('#comment-form_<?php echo $this->element_id ?>').body).autogrow();
    en4.seaocorepinboard.comments.attachCreateComment(scriptJquery('#comment-form_<?php echo $this->element_id ?>'),'<?php echo
$this->subject->getType()?>',<?php echo $this->subject->getIdentity() ?> , '<?php echo $this->widget_id ?>');

  <?php if($this->submit_post):?>
    scriptJquery('#comment-form_<?php echo $this->element_id ?>').style.display = '';scriptJquery('#comment-form_<?php echo
$this->subject->getGuid()?>').find('#body').focus()
    <?php endif; ?>
