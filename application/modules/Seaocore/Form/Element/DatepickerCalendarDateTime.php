...
class Seaocore_Form_Element_DatepickerCalendarDateTime extends Zend_Form_Element_Xhtml {

  public $helper = 'datePickerCalendarDateTime';
  public $ignoreValid;
  protected $_yearMin;
  protected $_yearMax;
  ...
  /*
    list of attributes
    'onSelectCustonFunction' => '', // If a function needs to be execute on on start date selection then use this parameter
    'onSelectCustonCodeToExecute' => "", // custom javascript code
    'minDate' => date('Y-m-d') // It is not working in date picker
  */
  ...
  public function init() {
    ...
    // 'Y-m-d H:i:s'
    $this->dateFormat = 'ymd'; // always this format will be used.
