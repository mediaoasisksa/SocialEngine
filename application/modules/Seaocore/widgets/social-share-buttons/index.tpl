...
<div id="seao_social_share_buttons_wrapper" style="">
  <div id="social_share_buttons_container">
    <?php if (Engine_Api::_()->core()->hasSubject() && $this->buttons && in_array('facebook',$this->buttons) && Engine_Api::_()->hasModuleBootstrap('facebookse')): 
              ...
              if ((Engine_Api::_()->seaocore()->checkVersion($facebookseversion, '4.6.0p2')) == 1) :
    ...
    <div class="button twitter_container">
   ...
   <?php if ($this->buttons && in_array('linkedin',$this->buttons)): ?>
    <div class="button linkedin_container">
      <a href="http://linkedin.com/share" class="linkedin-share-button" data-count="vertical">
    ...
    <div class="button google_container">
      ...
      <a class="google-share-button" data-count="vertical" data-size="tall" data-count="true" data-href="<?php echo $this->url() ?>">
...
<script type="text/javascript">
  en4.core.runonce.add(function() {
    en4.seaocore.setShareButtons(scriptJquery('#seao_social_share_buttons_wrapper'), scriptJquery('#social_share_buttons_container'), {
