...
<h3>
	<?php echo $this->translate("SocialApps.tech Plugins Integration and Information") ?>
</h3>
<p><?php echo $this->translate('This page lists all the plugins from SocialApps.tech that are integrable and compatible with this plugin. With this integration, you can enhance the functionality of this plugin, which in turn will increase traffic on your site by providing more features to the users of your site. To know more about our plugins on your site, please go to the "Plugins Information" section of "SocialApps.tech Core Plugin".<br />
The latest versions of these plugins are also available to you in your SocialApps.tech Client Area. Login into your SocialApps.tech Client Area here: <a href="http://www.socialapps.tech/user/login">http://www.socialapps.tech/user/login</a>.'); ?></p>
<br style="clear:both;" />
				...
				<?php foreach( $this->channel as $item ): ?>
					...
					if( empty($item['running_version']) ) {
						...
						$running_version = 0;
							...
							$versionInfo = Engine_Api::_()->seaocore()->checkVersion($running_version, $product_version);
