...
?></span>
    ...
    <?php if( isset($this->form) ): ?>
      - <a href='javascript:void(0);' onclick="if(scriptJquery('#comment-form-open-li_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity() ?>')){ scriptJquery('#comment-form-open-li_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity() ?>').style.display = 'none'; } scriptJquery('#comment-form_<?php echo $this->subject()->getType()?>_<?php
echo $this->subject()->getIdentity() ?>').style.display = '';scriptJquery('#comment-form_<?php echo
$this->subject()->getType()?>_<?php echo $this->subject()->getIdentity() ?>').find('#body').focus();"><?php echo
...
"'.$this->subject()->getIdentity().'", "'.($this->page + 1).'","'. $this->show_bottom_post .'")'
      ...
      <li id='comment-form-open-li_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity() ?>' onclick="(this).style.display ='none'; scriptJquery('#comment-form_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity() ?>').style.display = '';scriptJquery('#comment-form_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity() ?>').find('#body').focus();"> 
        <div/></div>
  ...
  <script type="text/javascript">
    en4.core.runonce.add(function(){
      $(scriptJquery('#comment-form_<?php echo $this->subject()->getType()?>_<?php echo $this->subject()->getIdentity()
?>').body).autogrow();
      en4.seaocore.comments.attachCreateComment(scriptJquery('#comment-form_<?php echo
