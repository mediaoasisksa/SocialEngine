...
class Seaocore_PinBoardCommentController extends Core_Controller_Action_Standard {
    ...
    public function createAction() {
        ...
        try {
            ...
            if ($subject->getType() == 'sitevideo_channel') {
...
//      }
    ...
    public function likeAction() {
        ...
        try {
            ...
            if (strpos($subject->getType(), "sitepage") !== false && !empty(Engine_Api::_()->seaocore()->checkVersion($sitepageVersion, '4.2.9p3'))) {
