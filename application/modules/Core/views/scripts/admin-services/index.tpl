  ...
  <tbody>
    <?php foreach( $this->paginator as $item ):
      ...
      <tr>
        ...
        <td data-label="<?php echo $this->translate("Type") ?>" class="nowrap">
          <?php echo $this->translate(!empty($serviceType['title']) ? $serviceType['title'] : 'Unknown') ?>
        </td>
        <td data-label="<?php echo $this->translate("Adapter") ?>" class="nowrap">
          <?php echo $this->translate(!empty($serviceProvider['title']) ? $serviceProvider['title'] : 'Unknown') ?>
        </td>
        <td data-label="<?php echo $this->translate("Profile Name") ?>" class="nowrap">
          <?php echo $this->translate(!empty($item['profile']) ? $item['profile'] : 'default') ?>
        </td>
        <td data-label="<?php echo $this->translate("Enabled") ?>" class="nowrap">
