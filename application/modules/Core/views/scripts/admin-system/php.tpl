...
<style type="text/css">
  ...
  #phpinfo h2 {font-size: 125%;background: transparent;color: #3b3e40;margin: 0;padding: 15px 0px;font-weight: 600;}
  ...
  #phpinfo .h h1 {font-weight: bold; color: #fff;margin:0;}
