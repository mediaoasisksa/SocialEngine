...
<h3>
    <?php echo $this->translate('Latest versions of SocialApps.tech themes for your site') ?>
</h3>
<p>
    <?php echo $this->translate('Here, you can upgrade the latest version of these themes by using ‘Upgrade’ button available in front of all the desired themes that needs to be upgraded.<br />The latest versions of these themes are also available to you in your SocialApps.tech Client Area. Login into your SocialApps.tech Client Area here: <a href="https://socialapps.tech/user/login" target="_blank">https://socialapps.tech/user/login</a>.'); ?>
</p><br />
...
if (empty($isPlugin)):
    ?>
    <?php echo '<div class="tip"><span>You have not purchased any SocialApps.tech Themes. Please click <a href="https://socialapps.tech/catalog/themes" target="_blank">here</a> to view and purchase engaging & attractive themes from SocialApps.tech.</span></div>'; ?>  
<?php endif; ?>