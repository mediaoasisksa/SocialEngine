...
<script type="text/javascript">
  ...
  function changeLicencekey(settingsPageElements, name) {
    if(settingsPageElements.find('#'+ name +'_lsettings')[0] && scriptJquery('#licence_'+ name)) {
  ...
  function configureModuleLicence(name, lastItem = false) { 
    ...
    if(scriptJquery('#licence_' + name) &&( scriptJquery('#licence_' + name).val() == false || scriptJquery('#licence_' + name).val().length == 0)&& !scriptJquery('#licence_' + name).hasClass('licence_error')) {
