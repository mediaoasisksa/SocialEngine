<?php 
  $tempUrl = $this->url(array('module' => 'sitecore', 'controller' => 'settings', 'action' => 'upgrade'), 'admin_default', false);
?>
...
<div class='tabs seaocore_sub_tabs'>
  <ul class="navigation">    
    ...
    <?php endif; ?>
      ...
      <li  class="<?php echo ($this->selectedMenuType == 'disabled')? 'active': ''; ?>">
        <a href="<?php echo $tempUrl; ?>?type=disabled"><?php echo $this->translate("Disabled Plugins"); ?></a>
      </li>
...
<div class="seaocore_tip">
  <span>
    Certified Plugins can not be upgrade from here, you need to login from SocialEngine.com account and download it.
  </span>
</div>
<style>
  .tabs ul li a{
