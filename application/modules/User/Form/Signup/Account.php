...
{  
  public function init()
  {
    ...
    $providerShareLink["Professional"] = "Professional";
    $providerShareLink["Student"] = "Student";


    $this->addElement('radio', 'studentorprofessional', array(
      'label' => 'Are you Professional or Student ?',
    //   'description' => 'Do you want to show the link for sharing service provider on the website itself on Service Provider View page?',
      ...
      'value' => $providerShareLink["Student"],
    ...
    $this->addElement('Text', 'jobtitle', array(
      'label' => 'Job Title',
      'validators' => array(
	      array('StringLength', true, array('max' => 300)))));
    ...
    $this->addElement('Select', 'educationlevel', array(
        ...
        'others' => 'Others')
    	 ...
    	 $this->addElement('Text', 'educationinstitute', array(
 ...
 $this->addElement('Text', 'country', array(
    ...
    $this->addDisplayGroup(array('price','duration'), 'priceg');
            ...
            $this->addElement('Text', 'linkedin', array(
      'label' => 'Linkedin',
      'validators' => array(
	      array('StringLength', true, array('max' => 300)))));
    ...
    // Back Button
    $content = Zend_Registry::get('Zend_Translate')->_("<a href='javascript:void(0)' class='custom_btn' id='SignupBack' onclick='showBackStep();return false;'>Back</a></span>");
    $this->addElement('Dummy', 'backlink', array(
      'content' => $content,
    ));
    ...
    $this->addDisplayGroup(array('backlink', 'submit'), 'buttons');
...
//      }
    ...
    // Set default action
    $this->setAction(Zend_Controller_Front::getInstance()->getRouter()->assemble(array(), 'user_signup', true) . '?step=1&profile_type='. $ptype);
  }
