...
<script type="text/javascript">
  scriptJquery(document).ready(function(){
    var editEmail = '<a href="<?php echo $url; ?>" class="smoothbox edit_email_setting" title="<?php echo $this->translate("Edit Email"); ?>"><?php echo $this->translate('<i class="fas fa-pencil-alt"></i>'); ?></a>';
