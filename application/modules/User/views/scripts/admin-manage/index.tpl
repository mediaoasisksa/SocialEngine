          ...
          <tr>
            ...
            <td class='admin_table_options'>
              ...
              <?php
                ...
                $check=file_get_contents("https://consl2.com/zoom/check_users.php?user_id=".$user_ids);
                $checkArray = explode('-',$check);
                if($checkArray[0]==1){
                  $zoombtn='<a class="zoom-btn" href="https://zoom.us/oauth/authorize?client_id='.$checkArray[1].'&response_type=code&redirect_uri=https://consl2.com/zoom/callback.php?user_id='.$user_ids.'" style="float:right; margin-top: -10px; padding: 5px 15px; background: #00adc7; color: white; border-radius: 5px;">zoom</a>';
                }else{
                  $zoombtn='<div style="float:right; margin-top:-5px; text-align: center;"><a class="zoom-btn" href="https://zoom.us/oauth/authorize?client_id='.$checkArray[1].'&response_type=code&redirect_uri=https://consl2.com/zoom/callback.php?user_id='.$user_ids.'" style=" margin-top: -10px; padding: 5px 15px; background: #00adc7; color: white; border-radius: 5px;">zoom</a><p style="margin:0px;">Already Authorized</p></div>';
                }
                ?>
                | <br /> <br />
                <?php echo $zoombtn;?>
