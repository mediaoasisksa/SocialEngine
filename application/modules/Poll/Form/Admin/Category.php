 ...
 * @license    http://www.socialengine.com/license/
 */
class Poll_Form_Admin_Category extends Engine_Form
{
  protected $_field;
  ...
  public function init()
  {
    ...
    $category = Engine_Api::_()->getItem('poll_category', $category_id);
    ...
    */
    ...
    $categoryPoll = $pollTable->isPollExists($category_id, 'category_id');
    $subcatPoll = $pollTable->isPollExists($category_id, 'subcat_id');
    $subsubcatPoll = $pollTable->isPollExists($category_id, 'subsubcat_id');
    
    if(engine_count($subcategory) == 0 && engine_count($subsubcategory) == 0 && empty($category->subsubcat_id) && empty($categoryPoll) && empty($subcatPoll) && empty($subsubcatPoll)) {
