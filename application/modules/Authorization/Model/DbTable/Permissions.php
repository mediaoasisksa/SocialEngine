  ...
  implements Authorization_Model_AdapterInterface
{
  ...
  {
    $privacySettings = array('auth_view', 'auth_comment', 'auth_tag', 'auth_photo', 'auth_event','lastLoginDate', 'lastUpdateDate', 'inviteeName', 'profileType', 'memberLevel', 'profileViews', 'joinedDate', 'friendsCount');
