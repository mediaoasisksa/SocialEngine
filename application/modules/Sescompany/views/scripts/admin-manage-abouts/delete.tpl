...
<form method="post" class="global_form_popup" action="<?php echo $this->url(array()) ?>">
  <div>
    <h3><?php echo $this->translate("Delete This About") ?></h3>
    <p>
      <?php echo $this->translate("Are you sure that you want to delete this about? It will not be recoverable after being deleted.") ?>
    </p>
    <br />
    <p>
