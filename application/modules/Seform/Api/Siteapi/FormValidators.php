 ...
 */
class Classified_Api_Siteapi_FormValidators extends Siteapi_Api_Validators {
    ...
    public function getFormValidators($subject = array(), $formValidators = array()) {
        ...
        // Add profile fields validations.
        $formValidators = Engine_Api::_()->getApi('Siteapi_Core', 'user')->getContentFieldsFormValidations("classified", $formValidators);
