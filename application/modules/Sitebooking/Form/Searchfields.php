...
class Sitebooking_Form_Searchfields extends Engine_Form {
  ...
  public function generate() {
    ...
    if ($this->_fieldType == 'sitebooking_review') {
      $profile_type = 'profile_type_review';
    } elseif ($this->_fieldType == 'sitebooking_ser') {
    ...
    $structure = Engine_Api::_()->sitebooking()->getFieldsStructureSearch($this->_fieldType, $this->_topLevelId, $this->_topLevelValue, true, $profileTypeIds);
