...
if(isset($_GET['resourcePath'])) {
    ...
    $entityid = "8ac7a4c87555d368017563f79da2136e";
    if($card == "mada") {
        $entityid = "8ac7a4c87555d368017563f80b461373";
    }
	...
	curl_setopt($ch, CURLOPT_HTTPHEADER, array(
	   "Content-Type: application/json",
                   ...
                   'Authorization:Bearer OGFjN2E0Yzg3NTU1ZDM2ODAxNzU2M2Y3NDQ2MjEzNjl8WmM2MnI5cmZqaw=='));
  ...
  <div>
    <div>
      ...
      <?php elseif( 1 ): ?>
        ...
        <p class="form-description">
          <?php echo $responseData['result']['description'] ?>
        </p>
        <div class="form-elements">
          <div id="buttons-wrapper" class="form-wrapper">
            <button type="submit">
