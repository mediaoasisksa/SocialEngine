      ...
      <?php foreach( $this->bookedItems as $item ): ?>
        <li class="_list">
          ...
          <div class='_info'>
            ...
            <?php 
               //$classroom = Engine_Api::_()->pa('classroom',$providerItem->parent_id);
               ?>
            <?php if($classroom):?>
            <div class='providers_browse_info_date'>
              <?php echo $this->htmlLink($classroom->getHref(),$this->itemPhoto($classroom, 'thumb.icon')); ?>
				    <span>
              <?php echo $this->translate('By');?>
              <?php echo $this->htmlLink($classroom->getHref(), $classroom->title); ?>
            </span>
            </div>
            <?php endif;?>
         ...
         <span class="_pricevalue"> <?php echo $this->locale()->toCurrency($item->total_charges,Engine_Api::_()->getApi('settings', 'core')->getSetting("sitebooking.unit",'USD')); ?></span>
            ...
            <div class="seaocore_button">
              ...
              if(count($this->zoomMeetingUrl)>0){
                ...
                ?>
                 <a class="buttonlink smoothbox" style="cursor: pointer;" value="<?php echo $value->join_url; ?>" onclick="joinMeeting('<?php echo $value->join_url; ?>')">Join Meeting <?php echo $date.' | '.$time; ?></a>
                 <?php 
                 }
                }
              }
