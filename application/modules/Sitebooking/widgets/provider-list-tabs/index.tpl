...
<script type="text/javascript">
  ...
  $$('.provider_list').each(function(el){
  ...
  listParams.forEach(function(item){
    if(item == "featured") {
      ...
      if(item == listParams[0] && item == "verified") {
        document.getElementById('hidden_filter_type_<?php echo $widgetIdentity ?>').value = document.getElementById("li_5_<?php echo $widgetIdentity ?>").getAttribute("data-target"); 
        document.getElementById("li_5_<?php echo $widgetIdentity ?>").addClass('active'); 
      }
      document.getElementById("li_5_<?php echo $widgetIdentity ?>").removeClass('dnone');
    }
...
<script type="text/javascript">                              
  ...
  $$('.provider_list').addEvent('click', function(){
