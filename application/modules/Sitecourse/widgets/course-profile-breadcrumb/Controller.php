  ...
  public function indexAction() {
   ...
   $course_url = Zend_Controller_Front::getInstance()->getRequest()->getParam('url');
    ...
    if (!empty($sitecourse->category_id)) {
      $this->view->category_name = $category_name =$this->view->tableCategory->getCategory($sitecourse->category_id, $a)->category_name;

      if (!empty($sitecourse->subcategory_id)) {
        $this->view->subcategory_name = $this->view->tableCategory->getCategory($sitecourse->subcategory_id,$a)->category_name;
