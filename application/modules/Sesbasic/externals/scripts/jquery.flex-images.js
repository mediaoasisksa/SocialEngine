...
(function($){ 
    $.fn.flexImages = function(options){
        var o = $.extend({ container: '.sesalbum_list_photo_grid', object: 'img', rowHeight: 180, maxRows: 0, truncate: false }, options);
    ...
    $.fn.sesbasicFlexImage = function(options){
        var o = $.extend({ container: '.sesbasic_list_photo_grid', object: 'img', rowHeight: 180, maxRows: 0, truncate: false }, options);
		...
		$.fn.activityImages = function(options){
        var o = $.extend({ container: '.sesalbum_activity_content', object: 'img', rowHeight: 200, maxRows: 0, truncate: false }, options);
        return this.each(function(){
            var $this = $(this), $items = $(o.container, $this), items = [], i = $items.eq(0), t = new Date().getTime();
            o.margin = i.outerWidth(true) - i.innerWidth();
            $items.each(function(){
            ...
            makeGridActivity($this, items, o);
            $(window).off('resize.activityImages'+$this.data('flex-t'));
            $(window).on('resize.activityImages'+t, function(){ makeGridActivity($this, items, o); });
            $this.data('flex-t', t)
        });
    }
		function makeGridActivity(container, items, o, noresize){
        ...
        function _helper(lastRow){
            if (o.maxRows && rows > o.maxRows || o.truncate && lastRow){ 
				...
				o.margin = $(o.container).outerWidth(true) - $(o.container).innerWidth();
